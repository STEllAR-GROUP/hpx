...
if(NOT TARGET Gperftools::gperftools)
  ...
  elseif("$ENV{GOOGLE_PERFTOOLS_ROOT}")
    ...
    file(TO_CMAKE_PATH "${GOOGLE_PERFTOOLS_INCLUDE_DIR}" GOOGLE_PERFTOOLS_INCLUDE_DIR)
    string(REPLACE "/include" "" GOOGLE_PERFTOOLS_ROOT "${GOOGLE_PERFTOOLS_INCLUDE_DIR}")
  endif()
  ...
  target_include_directories(Gperftools::gperftools SYSTEM INTERFACE ${GOOGLE_PERFTOOLS_INCLUDE_DIR})
  target_link_libraries(Gperftools::gperftools INTERFACE ${GOOGLE_PERFTOOLS_LIBRARIES})
endif()
