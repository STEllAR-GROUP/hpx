  ...
  if(NOT "${HPX_MALLOC}" MATCHES "system|System|SYSTEM")
    ...
    elseif(TBBMALLOC_FOUND)
      ...
      if(NOT HPX_USE_MMAP)
        ...
        set(hpx_LIBRARIES ${hpx_LIBRARIES} ${TBB_LIBRARY})
        hpx_include_sys_directories(${TBB_INCLUDE_DIR})
        hpx_link_sys_directories(${TBB_LIBRARY_DIR})
        hpx_add_definitions(-DHPX_TBB)
      endif()
    endif()
