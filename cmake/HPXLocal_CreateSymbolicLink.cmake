...
function(hpx_local_create_symbolic_link SYM_TARGET SYM_DESTINATION)
  if(WIN32)
    if(NOT EXISTS ${SYM_DESTINATION})
      if(IS_DIRECTORY ${SYM_TARGET})
        ...
        execute_process(
          COMMAND
            cmd /C
            "${PROJECT_SOURCE_DIR}/cmake/scripts/hpx_local_create_symbolic_link_directory.bat"
        ...
        execute_process(
          COMMAND
            cmd /C
            "${PROJECT_SOURCE_DIR}/cmake/scripts/hpx_local_create_symbolic_link_file.bat"
            ${SYM_DESTINATION} ${SYM_TARGET}
        )
      endif()
    endif()
...
endfunction(hpx_local_create_symbolic_link)
