...
if(EXISTS "${PROJECT_BINARY_DIR}/gh-pages")
  execute_process(
    COMMAND "${GIT_EXECUTABLE}" pull --rebase
    WORKING_DIRECTORY "${PROJECT_BINARY_DIR}/gh-pages"
...
if(HPX_WITH_GIT_BRANCH)
  ...
  set(DOCS_BRANCH_DEST "${PROJECT_BINARY_DIR}/gh-pages/docs/sphinx/branches/${HPX_WITH_GIT_BRANCH}")
...
if(HPX_WITH_GIT_TAG)
  ...
  set(DOCS_TAG_DEST "${PROJECT_BINARY_DIR}/gh-pages/docs/sphinx/tags/${HPX_WITH_GIT_TAG}")
  ...
  if("${HPX_WITH_GIT_TAG}" MATCHES "^[0-9]+\\.[0-9]+\\.[0-9]+$")
    ...
    set(DOCS_LATEST_DEST "${PROJECT_BINARY_DIR}/gh-pages/docs/sphinx/latest")
...
execute_process(
  ...
  WORKING_DIRECTORY "${PROJECT_BINARY_DIR}/gh-pages/docs/sphinx"
