...
if(NOT HPX_WITH_GIT_COMMIT OR "${HPX_WITH_GIT_COMMIT}" STREQUAL "None")
  ...
  set(HPX_WITH_GIT_COMMIT_SHORT "unknown")
else()
  hpx_info("GIT commit is ${HPX_WITH_GIT_COMMIT}.")
  if(NOT HPX_WITH_GIT_COMMIT_SHORT OR "${HPX_WITH_GIT_COMMIT_SHORT}" STREQUAL "None")
    string(SUBSTRING "${HPX_WITH_GIT_COMMIT}" 0 7 HPX_WITH_GIT_COMMIT_SHORT)
  endif()
endif()
