...
if(NOT HPX_AUTOMATIC_PREPROCESSING)
    ...
    macro(hpx_partial_preprocess_header file)
        ...
        if(NOT FILE_ADDED_ALREADY)
            ...
            if(HPX_PREPROCESS_HEADERS_${file}_GUARD)
                ...
                string(TOUPPER "${file}" GUARD)
                string(REGEX REPLACE "/" "_" GUARD "${GUARD}")
                string(REGEX REPLACE "\\." "_" GUARD "${GUARD}")
                string(REGEX REPLACE "HPX_" "HPX_PREPROCESSED_" GUARD "${GUARD}")
                set(HPX_PREPROCESS_HEADERS_${file}_GUARD ${GUARD} CACHE INTERNAL "" FORCE)
            endif()
        endif()
    endmacro()
    ...
    macro(hpx_setup_partial_preprocess_headers)
        ...
        if(MSVC)
            ...
            set(HPX_WAVE_ARGUMENTS "${HPX_WAVE_ARGUMENTS}-D_MSC_VER=1700\n")
