...
if(NOT MSVC)
  ...
  elseif(HPX_ROOT)
    set(source_dir "${HPX_ROOT}/share/cmake/tests")
  elseif($ENV{HPX_ROOT})
    set(source_dir "$ENV{HPX_ROOT}/share/cmake/tests")
  endif()
  ...
  if("${gcc_version_RESULT}" STREQUAL "0")
    ...
    math(EXPR GCC_MAJOR_VERSION "${GCC_VERSION} / 100000")
    math(EXPR GCC_MINOR_VERSION "${GCC_VERSION} / 100 % 1000")
    ...
    set(GCC_VERSION_STR "00.00.00" CACHE INTERNAL "" FORCE)
  endif()    
endif()
