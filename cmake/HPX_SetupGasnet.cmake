  ...
  if(NOT TARGET PkgConfig::GASNET)
    ...
    if((NOT GASNET_FOUND) AND HPX_WITH_FETCH_GASNET)
      ...
      elseif("${HPX_WITH_PARCELPORT_GASNET_CONDUIT}" STREQUAL "mpi")
        ...
        message(STATUS "MPI_CFLAGS\t${MPI_C_COMPILE_OPTIONS}")
        message(STATUS "MPI_CFLAGS_OTHER\t${MPI_C_COMPILE_DEFINITIONS}")
        message(STATUS "MPI_LDFLAGS\t${MPI_C_LINK_FLAGS}")
        message(STATUS "MPI_LIBRARY_DIRS\t${MPI_C_LIBRARIES}")
        message(STATUS "MPI_INCLUDE_DIRS\t${MPI_C_INCLUDE_DIRS}")

        set(MPI_CFLAGS_STR "")
        list(JOIN MPI_C_COMPILE_OPTIONS " " MPI_CFLAGS_STR)

        set(MPI_CFLAGS_OTHER_STR "")
        list(JOIN MPI_C_COMPILE_DEFINITIONS " " MPI_CFLAGS_OTHER_STR)

        set(MPI_LDFLAGS_STR "")
        list(JOIN MPI_C_LINK_FLAGS " " MPI_LDFLAGS_STR)
