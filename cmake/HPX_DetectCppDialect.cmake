        ...
        if(HPX_WITH_CXX14)
          ...
          if(HPX_WITH_CXX1Y)
            ...
            if(HPX_WITH_CXX11)
              set(CXX_FLAG -std=c++11 PARENT_SCOPE)
              hpx_info("C++ mode used: C++11")
              hpx_warn("Compiling in C++11 mode is deprecated. HPX will require C++14 or newer in future releases.")
            else()
              # ... otherwise try -std=c++0x
              check_cxx_compiler_flag(-std=c++0x HPX_WITH_CXX0X)
              if(HPX_WITH_CXX0X)
                hpx_info("C++ mode used: C++0x")
                hpx_error("HPX requires at least C++11")
              endif()
            endif()
          endif()
        endif()
...
function(hpx_detect_cpp_dialect)
  ...
  if(MSVC)
    ...
    elseif(HPX_WITH_CXX11)
      ...
      hpx_warn("Compiling in C++11 mode is deprecated. HPX will require C++14 support in future releases.")
