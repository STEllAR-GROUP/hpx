...
function(hpx_detect_cpp_dialect_non_msvc)
  ...
  if(HPX_WITH_CUDA AND NOT HPX_WITH_CUDA_CLANG)
    ...
    set(HPX_CXX_STANDARD 11 PARENT_SCOPE)
    ...
    if(HPX_WITH_CXX17)
      ...
      set(HPX_CXX_STANDARD 17 PARENT_SCOPE)
      ...
      if(HPX_WITH_CXX1Z)
        ...
        hpx_add_config_cond_define(BOOST_NO_AUTO_PTR)
        set(HPX_CXX_STANDARD 1z PARENT_SCOPE)
        ...
        if(HPX_WITH_CXX14)
          ...
          set(HPX_CXX_STANDARD 14 PARENT_SCOPE)
          ...
          if(HPX_WITH_CXX1Y)
            ...
            set(HPX_CXX_STANDARD 1y PARENT_SCOPE)
            ...
            if(HPX_WITH_CXX11)
              ...
              if(HPX_WITH_CXX0X)
                set(HPX_CXX_STANDARD 0x PARENT_SCOPE)
...
function(hpx_detect_cpp_dialect)
  ...
  if(MSVC)
    ...
    if(HPX_WITH_CXX2A)
      ...
      set(HPX_CXX_STANDARD 2a PARENT_SCOPE)
