...
function(hpx_local_target_architecture output_var)
  if(APPLE AND CMAKE_OSX_ARCHITECTURES)
    ...
    if(NOT HPXLocal_INTERNAL_ARCH_DETECT)
      ...
      set(HPXLocal_INTERNAL_ARCH_DETECT
          ${ARCH}
          CACHE INTERNAL ""
      )
    else()
      set(ARCH ${HPXLocal_INTERNAL_ARCH_DETECT})
    endif()
  endif()
