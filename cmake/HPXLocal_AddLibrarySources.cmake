...
function(hpx_local_add_library_sources name globtype)
  set(options APPEND)
  set(one_value_args)
...
# ##############################################################################
function(hpx_local_add_library_sources_noglob name)
  set(options APPEND)
  set(one_value_args)
  ...
  # hpx_local_print_list("DEBUG" "hpx_local_add_library_sources_noglob.${name}"
