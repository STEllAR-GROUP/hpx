...
void test_reduce_exception()
{
    ...
    test_reduce_exception(vec, IteratorTag());
    ...
    test_reduce_exception(execution_policy(vec), IteratorTag());
...
void test_reduce_bad_alloc()
{
    ...
    test_reduce_bad_alloc(vec, IteratorTag());
    ...
    test_reduce_bad_alloc(execution_policy(vec), IteratorTag());
