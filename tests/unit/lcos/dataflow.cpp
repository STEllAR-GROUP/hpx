...
typedef hpx::actions::plain_action<int (*)(int, int), &f> f_action;
...
typedef hpx::actions::plain_action<int (*)(int, int), &h> h_action;
...
typedef hpx::actions::plain_action<int (*)(), &g> g_action;
...
typedef hpx::actions::plain_action<void (*)(), &trigger> trigger_action;
...
typedef hpx::actions::plain_action<boost::uint64_t (*)(boost::uint64_t), &id> id_action;
...
typedef hpx::actions::plain_action<
...
#define M0(Z, N, D)                                                           \
    ...
    typedef hpx::actions::plain_action<void (*)(), &BOOST_PP_CAT(f, N)>       \
