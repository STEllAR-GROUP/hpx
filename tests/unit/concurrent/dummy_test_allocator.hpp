...
//     {
//         return CopyOnPropagateOnContSwap ? propagation_test_allocator(*this) :
...
//
//     template <class U>
//     propagation_test_allocator(const propagation_test_allocator<U,
//         PropagateOnContCopyAssign,
//         PropagateOnContMoveAssign,
//         PropagateOnContSwap,
...
//     }
//
//     propagation_test_allocator &operator=(
//         BOOST_COPY_ASSIGN_REF(propagation_test_allocator) x)
//     {
//         id_ = x.id_;
//         ctr_copies_ = x.ctr_copies_;
//         ctr_moves_ = x.ctr_moves_;
...
//
//     propagation_test_allocator &operator=(
//         BOOST_RV_REF(propagation_test_allocator) x)
//     {
//         id_ = x.id_;
//         ctr_copies_ = x.ctr_copies_;
//         ctr_moves_ = x.ctr_moves_;
...
//         const propagation_test_allocator &, const propagation_test_allocator &)
//     {
//         return true;
//     }
//
...
//
//     friend void swap(
//         propagation_test_allocator &l, propagation_test_allocator &r)
//     {
//         l.swap(r);
//     }
//
