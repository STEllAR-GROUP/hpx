...
#ifndef HPX_CONTAINER_TEST_FORWARD_TO_INPUT_ITERATOR_HPP
#define HPX_CONTAINER_TEST_FORWARD_TO_INPUT_ITERATOR_HPP
...
public:
    ...
    friend bool operator==(
        const input_iterator_wrapper &left, const input_iterator_wrapper &right)
    {
...
template <class FwdIterator>
input_iterator_wrapper<FwdIterator> make_input_from_forward_iterator(
