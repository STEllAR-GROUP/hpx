...
struct X
{
    ...
    int __cdecl f7(int a1, int a2, int a3, int a4, int a5, int a6, int a7)
    ...
    int __cdecl f8(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
