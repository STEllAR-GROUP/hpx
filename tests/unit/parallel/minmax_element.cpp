...
void test_minmax_element(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::test_iterator<base_iterator, IteratorTag> iterator;
    ...
    hpx::future<std::pair<iterator, iterator> > r =
        hpx::parallel::minmax_element(hpx::parallel::par_task,
            iterator(boost::begin(c)), iterator(end),
            std::less<std::size_t>());
    ...
    r = hpx::parallel::minmax_element(hpx::parallel::par_task,
        iterator(boost::begin(c)), iterator(boost::end(c)));
    rit = r.get();
    HPX_TEST(rit.first != end && rit.second != end);
...
void test_minmax_element()
{
    ...
    test_minmax_element(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_minmax_element_exception(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_minmax_element_exception()
{
    ...
    test_minmax_element_exception(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_minmax_element_bad_alloc(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_minmax_element_bad_alloc()
{
    ...
    test_minmax_element_bad_alloc(par(task), IteratorTag());
