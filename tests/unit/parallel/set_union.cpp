...
void test_set_union1(ExPolicy const& policy, IteratorTag)
{
    ...
    std::set_union(boost::begin(c1), boost::end(c1),
...
template <typename ExPolicy, typename IteratorTag>
void test_set_union1_async(ExPolicy const& p, IteratorTag)
{
//     typedef std::vector<std::size_t>::iterator base_iterator;
//     typedef test::test_iterator<base_iterator, IteratorTag> iterator;
//
...
//         result.wait();
//
//         bool expected = std::set_union(boost::begin(c1), boost::end(c1),
//             boost::begin(c2));
//
//         // verify values
...
///////////////////////////////////////////////////////////////////////////////
template <typename ExPolicy, typename IteratorTag>
void test_set_union2(ExPolicy const& policy, IteratorTag)
{
    BOOST_STATIC_ASSERT(hpx::parallel::is_execution_policy<ExPolicy>::value);
...
template <typename ExPolicy, typename IteratorTag>
void test_set_union2_async(ExPolicy const& p, IteratorTag)
{
//     typedef std::vector<std::size_t>::iterator base_iterator;
//     typedef test::test_iterator<base_iterator, IteratorTag> iterator;
//
...
//             hpx::parallel::set_union(p,
//                 iterator(boost::begin(c1)), iterator(boost::end(c1)),
//                 boost::begin(c2), std::set_union_to<std::size_t>());
//         result.wait();
//
//         bool expected = std::set_union(boost::begin(c1), boost::end(c1),
//             boost::begin(c2));
...
///////////////////////////////////////////////////////////////////////////////
// template <typename ExPolicy, typename IteratorTag>
// void test_set_union_exception(ExPolicy const& policy, IteratorTag)
// {
//     BOOST_STATIC_ASSERT(hpx::parallel::is_execution_policy<ExPolicy>::value);
//
//     typedef std::vector<std::size_t>::iterator base_iterator;
...
//
// template <typename ExPolicy, typename IteratorTag>
// void test_set_union_exception_async(ExPolicy const& p, IteratorTag)
// {
//     typedef std::vector<std::size_t>::iterator base_iterator;
//     typedef test::test_iterator<base_iterator, IteratorTag> iterator;
//
...
// ///////////////////////////////////////////////////////////////////////////////
// template <typename ExPolicy, typename IteratorTag>
// void test_set_union_bad_alloc(ExPolicy const& policy, IteratorTag)
// {
//     BOOST_STATIC_ASSERT(hpx::parallel::is_execution_policy<ExPolicy>::value);
//
//     typedef std::vector<std::size_t>::iterator base_iterator;
...
//
// template <typename ExPolicy, typename IteratorTag>
// void test_set_union_bad_alloc_async(ExPolicy const& p, IteratorTag)
// {
//     typedef std::vector<std::size_t>::iterator base_iterator;
//     typedef test::test_iterator<base_iterator, IteratorTag> iterator;
//
