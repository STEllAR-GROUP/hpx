...
void test_reverse(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::test_iterator<base_iterator, IteratorTag> iterator;
    ...
    auto f =
        hpx::parallel::reverse(hpx::parallel::par_task,
            iterator(boost::begin(c)), iterator(boost::end(c)));
    f.wait();
...
void test_reverse()
{
    ...
    test_reverse(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_reverse_exception(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_reverse_exception()
{
    ...
    test_reverse_exception(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_reverse_bad_alloc(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_reverse_bad_alloc()
{
    ...
    test_reverse_bad_alloc(par(task), IteratorTag());
