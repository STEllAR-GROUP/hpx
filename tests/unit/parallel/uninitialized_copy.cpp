...
template <typename ExPolicy, typename IteratorTag>
void test_uninitialized_copy_outiter(ExPolicy const& policy, IteratorTag)
{
        BOOST_STATIC_ASSERT(hpx::parallel::is_execution_policy<ExPolicy>::value);
...
template <typename ExPolicy, typename IteratorTag>
void test_uninitialized_copy_outiter_async(ExPolicy const& p, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::test_iterator<base_iterator, IteratorTag> iterator;
...
void test_uninitialized_copy()
{
    ...
    test_uninitialized_copy_outiter(seq, IteratorTag());
    test_uninitialized_copy_outiter(par, IteratorTag());
    test_uninitialized_copy_outiter(par_vec, IteratorTag());

    test_uninitialized_copy_outiter_async(seq(task), IteratorTag());
    test_uninitialized_copy_outiter_async(par(task), IteratorTag());

    test_uninitialized_copy_outiter(execution_policy(seq), IteratorTag());
    test_uninitialized_copy_outiter(execution_policy(par), IteratorTag());
    test_uninitialized_copy_outiter(execution_policy(par_vec), IteratorTag());

    test_uninitialized_copy_outiter(execution_policy(seq(task)), IteratorTag());
    test_uninitialized_copy_outiter(execution_policy(par(task)), IteratorTag());
}
