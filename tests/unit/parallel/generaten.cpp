...
void test_generate_n(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::test_iterator<base_iterator, IteratorTag> iterator;
    ...
    hpx::future<iterator> f =
        hpx::parallel::generate_n(hpx::parallel::par_task,
...
void test_generate_n()
{
    ...
    test_generate_n(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_generate_n_exception(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_generate_n_exception()
{
    ...
    test_generate_n_exception(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_generate_n_bad_alloc(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_generate_n_bad_alloc()
{
    ...
    test_generate_n_bad_alloc(par(task), IteratorTag());
