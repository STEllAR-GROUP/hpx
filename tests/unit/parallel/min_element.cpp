...
void test_min_element(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::test_iterator<base_iterator, IteratorTag> iterator;
    ...
    hpx::future<iterator> r = hpx::parallel::min_element(hpx::parallel::par_task,
        iterator(boost::begin(c)), iterator(end),
        std::less<std::size_t>());
    iterator rit = r.get();
    HPX_TEST(rit != end);
    ...
    r = hpx::parallel::min_element(hpx::parallel::par_task,
        iterator(boost::begin(c)), iterator(boost::end(c)));
    rit = r.get();
    HPX_TEST(rit != end);
...
void test_min_element()
{
    ...
    test_min_element(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_min_element_exception(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...

    {
        ...
        try {
            hpx::future<decorated_iterator> f =
                hpx::parallel::min_element(hpx::parallel::par_task,
                    decorated_iterator(
                        boost::begin(c),
                        [](){ throw std::runtime_error("test"); }),
                    decorated_iterator(boost::end(c)),
...
void test_min_element_exception()
{
    ...
    test_min_element_exception(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_min_element_bad_alloc(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_min_element_bad_alloc()
{
    ...
    test_min_element_bad_alloc(par(task), IteratorTag());
