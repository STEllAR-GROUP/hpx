...
void test_min_element(ExPolicy const& policy, IteratorTag)
{
    ...
    ref = std::min_element(boost::begin(c), boost::end(c));
    HPX_TEST(ref != ref_end);
    HPX_TEST_EQ(*ref, *r);
}

template <typename IteratorTag>
void test_min_element(hpx::parallel::task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::test_iterator<base_iterator, IteratorTag> iterator;
    ...
    hpx::future<iterator> r = hpx::parallel::min_element(hpx::parallel::task,
        iterator(boost::begin(c)), iterator(end),
        std::less<std::size_t>());
    iterator rit = r.get();
    HPX_TEST(rit != end);
    ...
    r = hpx::parallel::min_element(hpx::parallel::task,
        iterator(boost::begin(c)), iterator(boost::end(c)));
    rit = r.get();
    HPX_TEST(rit != end);
...
void test_min_element()
{
    ...
    test_min_element(task, IteratorTag());
    ...
    test_min_element(execution_policy(task), IteratorTag());
}
...
///////////////////////////////////////////////////////////////////////////////
template <typename ExPolicy, typename IteratorTag>
void test_min_element_exception(ExPolicy const& policy, IteratorTag)
{
    BOOST_STATIC_ASSERT(hpx::parallel::is_execution_policy<ExPolicy>::value);
...
template <typename IteratorTag>
void test_min_element_exception(hpx::parallel::task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...

    {
        ...
        try {
            hpx::future<decorated_iterator> f =
                hpx::parallel::min_element(hpx::parallel::task,
                    decorated_iterator(
                        boost::begin(c),
                        [](){ throw std::runtime_error("test"); }),
                    decorated_iterator(boost::end(c)),
...
///////////////////////////////////////////////////////////////////////////////
template <typename ExPolicy, typename IteratorTag>
void test_min_element_bad_alloc(ExPolicy const& policy, IteratorTag)
{
    BOOST_STATIC_ASSERT(hpx::parallel::is_execution_policy<ExPolicy>::value);
...
template <typename IteratorTag>
void test_min_element_bad_alloc(hpx::parallel::task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
