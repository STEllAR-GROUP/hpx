...
void test_any(ExPolicy && policy,
    hpx::partitioned_vector<T> & xvalues, Func && f, bool expected_result)
{
    bool result = hpx::parallel::any_of(policy, xvalues.begin(),
        xvalues.end(), f);
    HPX_TEST_EQ(result, expected_result);
}

template <typename ExPolicy, typename T, typename Func>
void test_any_async(ExPolicy && policy,
    hpx::partitioned_vector<T> & xvalues, Func && f, bool expected_result)
{
    bool result = hpx::parallel::any_of(policy, xvalues.begin(),
        xvalues.end(), f).get();
...
template <typename ExPolicy, typename T, typename Func>
void test_all(ExPolicy && policy,
    hpx::partitioned_vector<T> & xvalues, Func && f, bool expected_result)
{
    bool result = hpx::parallel::all_of(policy, xvalues.begin(),
        xvalues.end(), f);
    HPX_TEST_EQ(result, expected_result);
}

template <typename ExPolicy, typename T, typename Func>
void test_all_async(ExPolicy && policy,
    hpx::partitioned_vector<T> & xvalues, Func && f, bool expected_result)
{
    bool result = hpx::parallel::all_of(policy, xvalues.begin(),
        xvalues.end(), f).get();
...
template <typename ExPolicy, typename T, typename Func>
void test_none(ExPolicy && policy,
    hpx::partitioned_vector<T> & xvalues, Func && f, bool expected_result)
{
    bool result = hpx::parallel::none_of(policy, xvalues.begin(),
        xvalues.end(), f);
    HPX_TEST_EQ(result, expected_result);
}

template <typename ExPolicy, typename T, typename Func>
void test_none_async(ExPolicy && policy,
    hpx::partitioned_vector<T> & xvalues, Func && f, bool expected_result)
{
    bool result = hpx::parallel::none_of(policy, xvalues.begin(),
        xvalues.end(), f).get();
...
template <typename T>
void all_any_none_tests(std::vector<hpx::id_type> &localities)
{
    hpx::partitioned_vector<T> xvalues(SIZE, T(0), hpx::container_layout(localities));
    initialize(xvalues);

    test_any(hpx::parallel::execution::seq, xvalues, op5(), true);
    test_any(hpx::parallel::execution::par, xvalues, op5(), true);
    test_any_async(hpx::parallel::execution::seq(hpx::parallel::execution::task),
        xvalues, op5(), true);
    test_any_async(hpx::parallel::execution::par(hpx::parallel::execution::task),
        xvalues, op5(), true);
    ...
    test_all_async(hpx::parallel::execution::seq(hpx::parallel::execution::task),
        xvalues, op8(), false);
    test_all_async(hpx::parallel::execution::par(hpx::parallel::execution::task),
        xvalues, op8(), false);
    ...
    test_none_async(hpx::parallel::execution::seq(hpx::parallel::execution::task),
        xvalues, op8(), true);
    test_none_async(hpx::parallel::execution::par(hpx::parallel::execution::task),
        xvalues, op8(), true);
...
int main()
{
    ...
    all_any_none_tests<int>(localities);
    all_any_none_tests<double>(localities);
