...
void test_count(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    ...
    hpx::future<diff_type> f =
        hpx::parallel::count(hpx::parallel::par_task,
...
void test_count()
{
    ...
    test_count(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_count_exception(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef std::vector<std::size_t>::difference_type diff_type;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
...
void test_count_exception()
{
    ...
    test_count_exception(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_count_bad_alloc(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef std::vector<std::size_t>::difference_type diff_type;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
...
void test_count_bad_alloc()
{
    ...
    test_count_bad_alloc(par(task), IteratorTag());
