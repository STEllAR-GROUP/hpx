...
void test_min_element()
{
    ...
    test_min_element(execution_policy(execution::seq(execution::task)), IteratorTag());
    test_min_element(execution_policy(execution::par(execution::task)), IteratorTag());
#endif
}
...
void test_min_element_exception()
{
    ...
    test_min_element_exception_async(execution::seq(execution::task), IteratorTag());
    test_min_element_exception_async(execution::par(execution::task), IteratorTag());
    ...
    test_min_element_exception(execution_policy(execution::seq(execution::task)), IteratorTag());
    test_min_element_exception(execution_policy(execution::par(execution::task)), IteratorTag());
#endif
}
...
void test_min_element_bad_alloc()
{
    ...
    test_min_element_bad_alloc_async(execution::seq(execution::task), IteratorTag());
    test_min_element_bad_alloc_async(execution::par(execution::task), IteratorTag());
    ...
    test_min_element_bad_alloc(execution_policy(execution::seq(execution::task)), IteratorTag());
    test_min_element_bad_alloc(execution_policy(execution::par(execution::task)), IteratorTag());
#endif
}
