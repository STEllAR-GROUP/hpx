...
void test_transform_reduce_binary_exception()
{
    ...
    test_transform_reduce_binary_exception(execution_policy(seq),
        IteratorTag());
    test_transform_reduce_binary_exception(execution_policy(par),
        IteratorTag());

    test_transform_reduce_binary_exception(
        execution_policy(seq(task)),
        IteratorTag());
    test_transform_reduce_binary_exception(
        execution_policy(par(task)),
        IteratorTag());
#endif
}
