...
void test_replace_copy_if_exception()
{
    ...
    test_replace_copy_if_exception(execution_policy(execution::seq(execution::task)),
        IteratorTag());
    test_replace_copy_if_exception(execution_policy(execution::par(execution::task)),
        IteratorTag());
#endif
}
...
void test_replace_copy_if_bad_alloc()
{
    ...
    test_replace_copy_if_bad_alloc(execution_policy(execution::seq(execution::task)),
        IteratorTag());
    test_replace_copy_if_bad_alloc(execution_policy(execution::par(execution::task)),
        IteratorTag());
#endif
}
