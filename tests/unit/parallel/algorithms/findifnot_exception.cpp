...
void test_find_if_not_exception()
{
    ...
    test_find_if_not_exception_async(execution::seq(execution::task), IteratorTag());
    test_find_if_not_exception_async(execution::par(execution::task), IteratorTag());
    ...
    test_find_if_not_exception(execution_policy(execution::seq(execution::task)), IteratorTag());
    test_find_if_not_exception(execution_policy(execution::par(execution::task)), IteratorTag());
#endif
}
