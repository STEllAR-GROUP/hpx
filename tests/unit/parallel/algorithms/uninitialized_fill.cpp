...
void test_uninitialized_fill()
{
    ...
    test_uninitialized_fill_async(execution::seq(execution::task), IteratorTag());
    test_uninitialized_fill_async(execution::par(execution::task), IteratorTag());
    ...
    test_uninitialized_fill(execution_policy(execution::par_unseq), IteratorTag());

    test_uninitialized_fill(execution_policy(execution::seq(execution::task)), IteratorTag());
    test_uninitialized_fill(execution_policy(execution::par(execution::task)), IteratorTag());
#endif
}
...
void test_uninitialized_fill_exception()
{
    ...
    test_uninitialized_fill_exception_async(execution::seq(execution::task), IteratorTag());
    test_uninitialized_fill_exception_async(execution::par(execution::task), IteratorTag());
    ...
    test_uninitialized_fill_exception(execution_policy(execution::seq(execution::task)),
        IteratorTag());
    test_uninitialized_fill_exception(execution_policy(execution::par(execution::task)),
        IteratorTag());
#endif
}
...
void test_uninitialized_fill_bad_alloc()
{
    ...
    test_uninitialized_fill_bad_alloc_async(execution::seq(execution::task), IteratorTag());
    test_uninitialized_fill_bad_alloc_async(execution::par(execution::task), IteratorTag());
    ...
    test_uninitialized_fill_bad_alloc(execution_policy(execution::seq(execution::task)),
        IteratorTag());
    test_uninitialized_fill_bad_alloc(execution_policy(execution::par(execution::task)),
        IteratorTag());
#endif
}
