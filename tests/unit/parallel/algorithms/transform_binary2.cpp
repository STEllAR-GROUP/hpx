...
void test_transform_binary2()
{
    ...
    test_transform_binary2_async(execution::seq(execution::task), IteratorTag());
    test_transform_binary2_async(execution::par(execution::task), IteratorTag());
    ...
    test_transform_binary2(execution_policy(execution::par_unseq), IteratorTag());

    test_transform_binary2(execution_policy(execution::seq(execution::task)), IteratorTag());
    test_transform_binary2(execution_policy(execution::par(execution::task)), IteratorTag());
#endif
}
...
void test_transform_binary2_exception()
{
    ...
    test_transform_binary2_exception_async(execution::seq(execution::task), IteratorTag());
    test_transform_binary2_exception_async(execution::par(execution::task), IteratorTag());

#if defined(HPX_HAVE_GENERIC_EXECUTION_POLICY)
    test_transform_binary2_exception(execution_policy(execution::seq), IteratorTag());
    test_transform_binary2_exception(execution_policy(execution::par), IteratorTag());

    test_transform_binary2_exception(execution_policy(execution::seq(execution::task)),
        IteratorTag());
    test_transform_binary2_exception(execution_policy(execution::par(execution::task)),
        IteratorTag());
#endif
}
...
void test_transform_binary2_bad_alloc()
{
    ...
    test_transform_binary2_bad_alloc_async(execution::seq(execution::task), IteratorTag());
    test_transform_binary2_bad_alloc_async(execution::par(execution::task), IteratorTag());

#if defined(HPX_HAVE_GENERIC_EXECUTION_POLICY)
    test_transform_binary2_bad_alloc(execution_policy(execution::seq), IteratorTag());
    test_transform_binary2_bad_alloc(execution_policy(execution::par), IteratorTag());

    test_transform_binary2_bad_alloc(execution_policy(execution::seq(execution::task)),
        IteratorTag());
    test_transform_binary2_bad_alloc(execution_policy(execution::par(execution::task)),
        IteratorTag());
#endif
}
