...
void test_max_element(ExPolicy policy, IteratorTag)
{
    ...
    ref = std::max_element(boost::begin(c), boost::end(c));
    HPX_TEST(ref != ref_end);
    HPX_TEST_EQ(*ref, *r);
}
...
void test_max_element()
{
    ...
    test_max_element(execution_policy(execution::seq(execution::task)), IteratorTag());
    test_max_element(execution_policy(execution::par(execution::task)), IteratorTag());
#endif
}
...
void test_max_element_exception()
{
    ...
    test_max_element_exception_async(execution::seq(execution::task), IteratorTag());
    test_max_element_exception_async(execution::par(execution::task), IteratorTag());
    ...
    test_max_element_exception(execution_policy(execution::seq(execution::task)), IteratorTag());
    test_max_element_exception(execution_policy(execution::par(execution::task)), IteratorTag());
#endif
}
...
void test_max_element_bad_alloc()
{
    ...
    test_max_element_bad_alloc_async(execution::seq(execution::task), IteratorTag());
    test_max_element_bad_alloc_async(execution::par(execution::task), IteratorTag());
    ...
    test_max_element_bad_alloc(execution_policy(execution::seq(execution::task)), IteratorTag());
    test_max_element_bad_alloc(execution_policy(execution::par(execution::task)), IteratorTag());
#endif
}
