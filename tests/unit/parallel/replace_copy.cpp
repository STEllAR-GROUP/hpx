...
void test_replace_copy(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::test_iterator<base_iterator, IteratorTag> iterator;
    ...
    hpx::future<void> f =
        hpx::parallel::replace_copy(hpx::parallel::par_task,
            iterator(boost::begin(c)), iterator(boost::end(c)),
            boost::begin(d1), c[idx], c[idx]+1);
    f.wait();
...
void test_replace_copy()
{
    ...
    test_replace_copy(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_replace_copy_exception(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_replace_copy_exception()
{
    ...
    test_replace_copy_exception(par(task), IteratorTag());
...
template <typename IteratorTag>
void test_replace_copy_bad_alloc(hpx::parallel::parallel_task_execution_policy, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_replace_copy_bad_alloc()
{
    ...
    test_replace_copy_bad_alloc(par(task), IteratorTag());
