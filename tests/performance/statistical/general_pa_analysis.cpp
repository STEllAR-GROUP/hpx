...
void run_empty(uint64_t number){
    ...
    double t = t1.elapsed();
    cout<<"Mean time of running non-packaged functions sequentially: ";
    cout<<t/number*1e9<<" ns\n\n";
    cout<<flush;
}
template <typename Vector, typename Package, typename Action, typename T>
