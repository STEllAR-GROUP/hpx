...
///////////////////////////////////////////////////////////////////////////////
template <typename DataType, typename Pred>
double run_partition_copy_benchmark_seq(int test_count,
    std::vector<DataType> const& v, Pred pred)
{
...
///////////////////////////////////////////////////////////////////////////////
template <typename DataType, typename Pred>
double run_partition_copy_benchmark_par(int test_count,
    std::vector<DataType> const& v, Pred pred)
{
...
///////////////////////////////////////////////////////////////////////////////
template <typename DataType, typename Pred>
double run_partition_copy_benchmark_par_unseq(int test_count,
    std::vector<DataType> const& v, Pred pred)
{
    ...
    {
        using namespace hpx::parallel;
        partition_copy(execution::par_unseq,
            std::begin(v), std::end(v),
            std::begin(result_true), std::begin(result_false),
            pred);
    }
...
int hpx_main(boost::program_options::variables_map& vm)
{
    ...
    double time_std =
        run_partition_copy_benchmark_std(test_count, v, pred);
    double time_seq =
        run_partition_copy_benchmark_seq(test_count, v, pred);
    double time_par =
        run_partition_copy_benchmark_par(test_count, v, pred);
    double time_par_unseq =
        run_partition_copy_benchmark_par_unseq(test_count, v, pred);
