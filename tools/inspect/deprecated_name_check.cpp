...
namespace boost
{
  namespace inspect
  {
    deprecated_names const names[] =
    {
      ...
      { "(\\bboost\\s*::\\s*exception_ptr\\b)", "hpx::compat::exception_ptr" },
      { "(\\bboost\\s*::\\s*copy_exception\\b)", "hpx::compat::make_exception_ptr" },
      { "(\\bboost\\s*::\\s*current_exception\\b)", "hpx::compat::current_exception" },
      { "(\\bboost\\s*::\\s*rethrow_exception\\b)", "hpx::compat::rethrow_exception" },
      /////////////////////////////////////////////////////////////////////////
