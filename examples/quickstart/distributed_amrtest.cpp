...
*/
    ...
    follows it.
    */
naming::id_type getnumber(int hello);
...
int hpx_main(po::variables_map &vm)
{
    ...
    */
    ...
    
    {
        ...
        */
        lcos::eager_future<getnumber_action> n1(that_prefix,1);
        lcos::eager_future<getnumber_action> n2(this_prefix,2);
...
{  
    ...
    std::cout << " TEST HELLO " << hello << std::endl;
