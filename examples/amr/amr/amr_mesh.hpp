...
namespace hpx { namespace components { namespace amr 
{
    ...
    public:
        amr_mesh(naming::id_type gid, bool freeonexit = false)
        ...
        execute_async(components::component_type function_type, 
            std::size_t numvalues, std::size_t numsteps, 
            components::component_type logging_type = components::component_invalid)
        {
            return this->base_type::execute_async(this->gid_, function_type,
                numvalues, numsteps, logging_type);
        }

        std::vector<naming::id_type> 
        execute(components::component_type function_type, 
            std::size_t numvalues, std::size_t numsteps, 
            components::component_type logging_type = components::component_invalid)
        {
            return this->base_type::execute(this->gid_, function_type,
                numvalues, numsteps, logging_type);
        }
    };
