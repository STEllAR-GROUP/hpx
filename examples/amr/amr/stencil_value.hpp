...
{
    /// \class stencil_value stencil_value.hpp hpx/components/amr/stencil_value.hpp
    template <int N>
    class stencil_value 
      : public client_base<stencil_value<N>, amr::stubs::stencil_value<N> >
    {
    private:
        typedef 
            client_base<stencil_value<N>, amr::stubs::stencil_value<N> > 
        base_type;
