...
namespace nqueen
{
    ...
    public:
        ...
        hpx::lcos::unique_future<list_type> access_board_async(){
        ...
        hpx::lcos::unique_future<bool> check_board_async(list_type const& list,
            std::size_t level)
        {
        ...
        hpx::lcos::unique_future<std::size_t>
