...
// (using the Boost helper routines) package up the command line options and call hpx::init(). 
// hpx::init() initializes the runtime environment and then calls hpx_main(). This routine must be present, 
...
int main(int argc, char* argv[])
{
    ...
    /* 
       Initialize and run HPX; there are (at least) two ways to do this. One is using hpx::init
...
/* 
    ...
    by hpx::init(), but this routine is also in the call chain when you choose to create the 
