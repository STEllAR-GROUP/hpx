...
typedef hpx::components::managed_component<
    hpx::components::nbody::server::dynamic_stencil_value 
...
/// for this component. For instance the configuration file nbody.ini may look 
/// like:
/// 
/// [hpx.components.dynamic_stencil_double]      # this must match the string below
/// name = nbody                               # this must match the name of the shared library
