...
#if !defined(HPX_COMPONENTS_NBODY_STUBS_STENCIL_VALUE_NOV_02_2008_0447PM)
#define HPX_COMPONENTS_NBODY_STUBS_STENCIL_VALUE_NOV_02_2008_0447PM
...
{
    /// \class dynamic_stencil_value dynamic_stencil_value.hpp hpx/components/nbody/stubs/dynamic_stencil_value.hpp
    struct dynamic_stencil_value 
      : components::stubs::stub_base<nbody::server::dynamic_stencil_value >
    {
        ///////////////////////////////////////////////////////////////////////
            ...
            naming::id_type const& targetgid, naming::id_type const& initial)
        {
            ...
            typedef nbody::server::dynamic_stencil_value::call_action action_type;
        ...
        get_output_ports_async(naming::id_type const& gid)
        {
            ...
            // we simply return the initialized future_value, the caller needs
            // to call get() on the return value to obtain the result
            typedef nbody::server::dynamic_stencil_value::get_output_ports_action 
            action_type;
        ...
        {
            typedef 
                nbody::server::dynamic_stencil_value::connect_input_ports_action 
            action_type;
        ...
        {
            typedef
                nbody::server::dynamic_stencil_value::set_functional_component_action 
            action_type;
        ...
        {
            typedef nbody::server::dynamic_stencil_value::start_action 
                action_type;
