...
#if !defined(HPX_COMPONENTS_NBODY_STENCIL_OCT_17_2008_0847AM)
#define HPX_COMPONENTS_NBODY_STENCIL_OCT_17_2008_0847AM

#include "../nbody/server/functional_component.hpp"
...
namespace hpx { namespace components { namespace nbody 
{
    ...
    class HPX_COMPONENT_EXPORT stencil 
      : public nbody::server::functional_component
    {
    private:
        typedef nbody::server::functional_component base_type;
