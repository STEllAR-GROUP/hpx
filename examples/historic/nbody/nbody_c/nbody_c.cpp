...
///////////////////////////////////////////////////////////////////////////////
typedef hpx::components::nbody::stencil had_stencil_type;
typedef hpx::components::nbody::server::logging had_logging_type;
...
/// name = nbody_test           # this must match the name of the shared library
