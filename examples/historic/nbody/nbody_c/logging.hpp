...
#if !defined(HPX_COMPONENTS_NBODY_LOGGING_NOV_10_2008_0719PM)
#define HPX_COMPONENTS_NBODY_LOGGING_NOV_10_2008_0719PM
...
{
    ///////////////////////////////////////////////////////////////////////////
    struct logging : public components::stubs::stub_base<nbody::server::logging>
    {
        ///////////////////////////////////////////////////////////////////////
        static void logentry(naming::id_type const& gid, 
            stencil_data const& val, int row, int logcode, Parameter const& par)
        {
            typedef nbody::server::logging::logentry_action action_type;
...
{
    ///////////////////////////////////////////////////////////////////////////
    class logging : public client_base<logging, nbody::stubs::logging>
    {
    private:
        typedef client_base<logging, nbody::stubs::logging> base_type;
