...
///////////////////////////////////////////////////////////////////////////////
typedef hpx::components::adaptive1d::stencil adaptive1d_stencil_type;
typedef hpx::components::adaptive1d::server::logging adaptive1d_logging_type;
...
/// for this component. For instance the configuration file adaptive1d.ini may look
/// like:
///
...
HPX_DEFINE_GET_COMPONENT_TYPE(adaptive1d_logging_type);
