...
#if !defined(HPX_COMPONENTS_STUBS_RANDOM_JUL_18_2011_1125AM)
#define HPX_COMPONENTS_STUBS_RANDOM_JUL_18_2011_1125AM
...
namespace hpx { namespace components { namespace stubs
{
    ...
    struct random_mem_access : stub_base<server::random_mem_access>
    {
        ...
        static lcos::future_value<void> add_async(naming::id_type gid) 
        {
            // Create an eager_future, execute the required action,
            // we simply return the initialized eager_future, the caller needs
            // to call get() on the return value to obtain the result
        ...
        static lcos::future_value<void> print_async(naming::id_type gid) 
        {
            // Create an eager_future, execute the required action,
            // we simply return the initialized eager_future, the caller needs
            // to call get() on the return value to obtain the result
