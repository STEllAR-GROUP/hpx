...
#if !defined(HPX_COMPONENTS_NBODY_STENCIL_VALUE_NOV_02_2008_0506PM)
#define HPX_COMPONENTS_NBODY_STENCIL_VALUE_NOV_02_2008_0506PM
...
{
    /// \class dynamic_stencil_value dynamic_stencil_value.hpp hpx/components/nbody/dynamic_stencil_value.hpp
    class dynamic_stencil_value 
      : public client_base<dynamic_stencil_value, nbody::stubs::dynamic_stencil_value >
    {
    private:
        typedef 
            client_base<dynamic_stencil_value, nbody::stubs::dynamic_stencil_value > 
        base_type;
