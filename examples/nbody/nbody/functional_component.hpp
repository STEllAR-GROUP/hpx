...
#if !defined(HPX_COMPONENTS_NBODY_FUNCTIONAL_COMPONENT_NOV_05_2008_0357PM)
#define HPX_COMPONENTS_NBODY_FUNCTIONAL_COMPONENT_NOV_05_2008_0357PM
...
namespace hpx { namespace components { namespace nbody 
{
    ...
    class functional_component
      : public client_base<functional_component, nbody::stubs::functional_component>
    {
    private:
        typedef 
            client_base<functional_component, nbody::stubs::functional_component>
        base_type;
