...
#if !defined(HPX_COMPONENTS_NBODY_SERVER_FUNCTIONAL_COMPONENT_OCT_19_2008_1234PM)
#define HPX_COMPONENTS_NBODY_SERVER_FUNCTIONAL_COMPONENT_OCT_19_2008_1234PM
...
namespace hpx { namespace components { namespace nbody { namespace server 
{
    ...
    public:
        ...
        // component
        typedef nbody::server::functional_component wrapping_type;
