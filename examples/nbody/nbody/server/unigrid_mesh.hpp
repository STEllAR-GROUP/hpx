...
#if !defined(HPX_COMPONENTS_NBODY_SERVER_RK_MESH_FEB_25_2010_0153AM)
#define HPX_COMPONENTS_NBODY_SERVER_RK_MESH_FEB_25_2010_0153AM
...
namespace hpx { namespace components { namespace nbody { namespace server 
{
    ...
    public:
        ...
        typedef nbody::server::unigrid_mesh wrapping_type;
