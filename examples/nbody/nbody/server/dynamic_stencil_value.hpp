...
#if !defined(HPX_COMPONENTS_NBODY_SERVER_DZNAMIC_STENCIL_VALUE)
#define HPX_COMPONENTS_NBODY_SERVER_DZNAMIC_STENCIL_VALUE
...
{
    /// \class dynamic_stencil_value dynamic_stencil_value.hpp hpx/components/nbody/server/dynamic_stencil_value.hpp
    ...
    protected:
        ...
        // of the proper type
        typedef nbody::server::stencil_value_in_adaptor in_adaptor_type;

        // the out_adaptors_type is the concrete dynamic_stencil_value_out_adaptor
        // of the proper type
        typedef 
            managed_component<nbody::server::stencil_value_out_adaptor>
        out_adaptor_type;
