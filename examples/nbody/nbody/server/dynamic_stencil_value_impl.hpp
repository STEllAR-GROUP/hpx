...
#if !defined(HPX_COMPONENTS_NBODY_DYNAMIC_STENCIL_VALUE_IMPL)
#define HPX_COMPONENTS_NBODY_DYNAMIC_STENCIL_VALUE_IMPL
...
namespace hpx { namespace components { namespace nbody { namespace server 
{
    ...
    struct eval_helper
    {
            ...
            int row, int column, Adaptor &in, Parameter const& par)
        {
            ...
            return components::nbody::stubs::functional_component::eval(
        ...
        Parameter const& par)
    {
        ...
        return components::nbody::stubs::functional_component::alloc_data(
            gid, -1, -1, row, par);
    }
