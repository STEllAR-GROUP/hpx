...
#if !defined(HPX_COMPONENTS_NBODY_STUBS_FUNCTIONAL_COMPONENT_NOV_05_2008_0338PM)
#define HPX_COMPONENTS_NBODY_STUBS_FUNCTIONAL_COMPONENT_NOV_05_2008_0338PM
...
///////////////////////////////////////////////////////////////////////////////
namespace hpx { namespace components { namespace nbody { namespace stubs 
{
    ///////////////////////////////////////////////////////////////////////////
    struct functional_component
      : components::stubs::stub_base<nbody::server::functional_component>
    {
        ///////////////////////////////////////////////////////////////////////
            ...
            Parameter const& par)
        {
            ...
            typedef nbody::server::functional_component::eval_action action_type;
            ...
            Parameter const& par)
        {
            ...
            // we simply return the initialized future_value, the caller needs
            // to call get() on the return value to obtain the result
            typedef nbody::server::functional_component::alloc_data_action action_type;
        ...
        {
            typedef nbody::server::functional_component::init_action action_type;
