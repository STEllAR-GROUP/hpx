...
#if !defined(HPX_COMPONENTS_NBODY_STUBS_RK_MESH_FEB_16_2010_0313PM)
#define HPX_COMPONENTS_NBODY_STUBS_RK_MESH_FEB_25_2010_0313PM
...
namespace hpx { namespace components { namespace nbody { namespace stubs 
{
    ///////////////////////////////////////////////////////////////////////////
    struct unigrid_mesh
      : components::stubs::stub_base<nbody::server::unigrid_mesh>
    {
        ///////////////////////////////////////////////////////////////////////
            ...
            Parameter const& par)
        {
            ...
            typedef nbody::server::unigrid_mesh::init_execute_action action_type;
            ...
            Parameter const& par)
        {
            ...
            // we simply return the initialized future_value, the caller needs
            // to call get() on the return value to obtain the result
            typedef nbody::server::unigrid_mesh::execute_action action_type;
