...
#include "sendrecv_hpx/server/partition.hpp"

/// This function initializes a vector of \a sendrecv::point clients,
...
{
    {
        ...
        hpx::components::get_component_type<sendrecv::server::partition>();
...

        {
          ...
          sendrecv::server::partition::loop_action loop;
