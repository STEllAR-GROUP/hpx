...
inline void MPI_Init_thread(int*, char***, int, int* p) { *p = MPI_THREAD_MULTIPLE; }
inline void MPI_Finalize() {}

inline void MPI_Irecv(void*, int, int, int, int, int, MPI_Request*) { std::abort(); }
inline void MPI_Isend(void*, int, int, int, int, int, MPI_Request*) { std::abort(); }
