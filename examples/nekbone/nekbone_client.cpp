...
#include "nekbone_hpx/server/partition.hpp"

/// This function initializes a vector of \a nekbone::point clients,
...
{
    {
        ...
        hpx::components::get_component_type<nekbone::server::partition>();
...

        {
          ...
          nekbone::server::partition::loop_action loop;
