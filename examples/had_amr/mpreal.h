...
public:
  ...
  mpreal& operator*=(const int v);
#if defined(_MSC_VER)
  mpreal& operator*=(const unsigned __int64 v);
#endif
...
const mpreal operator*(const int b, const mpreal& a);
#if defined(_MSC_VER)
const mpreal operator*(const unsigned __int64 b, const mpreal& a);
#endif
...
#if defined(_MSC_VER)
inline mpreal& mpreal::operator*=(const unsigned __int64 v)
{
  mpfr_mul_si(mp,mp,v,default_rnd);
  return *this;
}
...
#if defined(_MSC_VER)
inline const mpreal operator*(const unsigned __int64 b, const mpreal& a)
{
  return mpreal(a) *= b;
}
#endif
