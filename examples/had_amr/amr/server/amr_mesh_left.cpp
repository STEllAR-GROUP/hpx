...
#include "amr_mesh_left.hpp"

///////////////////////////////////////////////////////////////////////////////
typedef hpx::components::amr::server::amr_mesh_left had_amr_mesh_left_type;

///////////////////////////////////////////////////////////////////////////////
// Serialization support for the actions
HPX_REGISTER_ACTION_EX(had_amr_mesh_left_type::init_execute_action, had_amr_mesh_left_init_execute_action);
HPX_REGISTER_ACTION_EX(had_amr_mesh_left_type::execute_action, had_amr_mesh_left_execute_action);

HPX_REGISTER_MINIMAL_COMPONENT_FACTORY(
    hpx::components::simple_component<had_amr_mesh_left_type>, had_amr_mesh_left);
HPX_DEFINE_GET_COMPONENT_TYPE(had_amr_mesh_left_type);

///////////////////////////////////////////////////////////////////////////////
namespace hpx { namespace components { namespace amr { namespace server 
{
    amr_mesh_left::amr_mesh_left()
      : numvalues_(0)
    {}

    ///////////////////////////////////////////////////////////////////////////////
    // Initialize functional components by setting the logging component to use
    void amr_mesh_left::init(distributed_iterator_range_type const& functions,
    ...
    void amr_mesh_left::init_stencils(distributed_iterator_range_type const& stencils,
    ...
    void amr_mesh_left::get_output_ports(
    ...
    void amr_mesh_left::connect_input_ports(
            ...
            for (int i = 0; stencil != r.second; ++stencil, ++i)
            {
                ...
                if (step==0) {
                    if (i==0) {
                      ...
                      output_ports += outputs[step+2][2][0];  
                    } else if (i==7) {
                      output_ports += outputs[step+2][2][1];  
                    } else if (i==8) {
                      output_ports += outputs[step+2][2][2];  
                    } else {
                      BOOST_ASSERT(false);
                    }
                } else if (step==1) {
                    if (i==0) {
                      ...
                      output_ports += outputs[step-1][4][4],  
                                      outputs[step-1][5][3],  
                                      outputs[step-1][6][2],  
                                      outputs[step-1][7][1],  
                                      outputs[step-1][8][0];  
                    } else if (i==6) {
                      output_ports += outputs[step-1][6][3],  
                                      outputs[step-1][7][2],  
                                      outputs[step-1][8][1];  
                    } else {
                      BOOST_ASSERT(false);
                    ...
                    if (i==0) {
                      ...
                      output_ports += outputs[step-1][2][2],  
                                      outputs[step-1][3][2],  
                                      outputs[step-1][4][2],  
                                      outputs[step-1][5][1],  
                                      outputs[step-1][6][0];
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void amr_mesh_left::prepare_initial_data(
    ...
    std::vector<naming::id_type> amr_mesh_left::init_execute(
        components::component_type function_type,
        components::component_type logging_type, 
        std::size_t level, double x, Parameter const& par)
    {
        std::size_t numvalues = 9;
        ...
        {
            factory.create_components(stencil_type, 9),
    ...
    std::vector<naming::id_type> amr_mesh_left::execute(
        std::vector<naming::id_type> const& initial_data,
        components::component_type function_type,
