...
#if !defined(HPX_COMPONENTS_AMR_SERVER_MESH_LEFT_DEC_4_2009_1052AM)
#define HPX_COMPONENTS_AMR_SERVER_MESH_LEFT_DEC_4_2009_1052AM
...
{
    ///////////////////////////////////////////////////////////////////////////
    class HPX_COMPONENT_EXPORT amr_mesh_left
      : public simple_component_base<amr_mesh_left>
    {
    private:
        typedef simple_component_base<amr_mesh_left> base_type;
    ...
    public:
        ...
        typedef amr::server::amr_mesh_left wrapping_type;
        ...
        enum actions
        {
            amr_mesh_left_init_execute = 0,
            amr_mesh_left_execute = 1
        };
        ...
        typedef hpx::actions::result_action5<
            amr_mesh_left, std::vector<naming::id_type>, amr_mesh_left_init_execute, 
            components::component_type, 
            components::component_type, std::size_t, had_double_type,
            Parameter const&, &amr_mesh_left::init_execute
        > init_execute_action;

        typedef hpx::actions::result_action4<
            amr_mesh_left, std::vector<naming::id_type>, amr_mesh_left_execute, 
            std::vector<naming::id_type> const&,
            components::component_type, 
            components::component_type, Parameter const&, &amr_mesh_left::execute
        > execute_action;
