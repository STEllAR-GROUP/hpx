...
namespace hpx { namespace components { namespace amr { namespace stubs 
{
    ///////////////////////////////////////////////////////////////////////////
    struct rk_mesh
      : components::stubs::stub_base<amr::server::rk_mesh>
    {
        ///////////////////////////////////////////////////////////////////////
            ...
            Parameter const& par)
        {
            ...
            typedef amr::server::rk_mesh::init_execute_action action_type;
            ...
            Parameter const& par)
        {
            ...
            // we simply return the initialized future_value, the caller needs
            // to call get() on the return value to obtain the result
            typedef amr::server::rk_mesh::execute_action action_type;
