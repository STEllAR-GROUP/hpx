...
HPX_REGISTER_PLAIN_ACTION(jacobsthal_action);

typedef eager_future<jacobsthal_action> jacobsthal_future;
...
boost::uint64_t jacobsthal(
  ...
  , boost::uint64_t n
    ...
    {
        jacobsthal_future n1(prefix, prefix, n - 1);
        jacobsthal_future n2(prefix, prefix, n - 2);
...
int main(int argc, char* argv[])
{
    ...
    desc_commandline.add_options()
        ...
        , "n value for the Jacobsthal function") 
        ;
