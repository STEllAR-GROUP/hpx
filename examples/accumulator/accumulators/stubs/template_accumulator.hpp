...
namespace examples { namespace stubs
{
    ...
    struct managed_accumulator
      : hpx::components::stub_base<server::template_accumulator>
    {
        ///////////////////////////////////////////////////////////////////////
        ...
        {
            typedef server::template_accumulator::reset_action action_type;
        ...
        {
            typedef server::template_accumulator::add_action<T> action_type;
...
//             boost::mpl::print<typename server::template_accumulator::create_add_action<T>::type::derived_type::result_type> x = 0;
        ...
        {
            typedef server::template_accumulator::query_action action_type;
