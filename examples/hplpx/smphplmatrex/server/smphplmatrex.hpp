...
namespace hpx { namespace components { namespace server
{
    ...
    typedef hpx::lcos::packaged_action<server::smphplmatrex::assign_action> assign_future;
    //the search pivots future
    typedef hpx::lcos::packaged_action<server::smphplmatrex::search_action> search_future;
    //Here is the swap future, which works the same way as the assign future
    typedef hpx::lcos::packaged_action<server::smphplmatrex::swap_action> swap_future;
    //This future corresponds to the Gaussian elimination functions
    typedef hpx::lcos::packaged_action<server::smphplmatrex::gmain_action> gmain_future;
    ...
    typedef
        hpx::lcos::packaged_action<server::smphplmatrex::partbsub_action> partbsub_future;
    //the final future type for the class is used for checking the accuracy of
    //the results of the LU decomposition
    typedef hpx::lcos::packaged_action<server::smphplmatrex::check_action> check_future;
