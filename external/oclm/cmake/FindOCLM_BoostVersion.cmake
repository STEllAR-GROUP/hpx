...
macro(get_boost_version)
  ...
  if(NOT BOOST_USE_SYSTEM)
    ...
    if(NOT BOOST_LIBRARY_DIR AND BOOST_ROOT)
      ...
      oclm_debug("boost.version" "Using ${BOOST_LIBRARY_DIR} as Boost shared library directory")
    endif()
    ...
    if(${BOOST_VERSION_HPP} STREQUAL BOOST_VERSION_HPP-NOTFOUND)
      if(NOT BOOST_INCLUDE_DIR)
        oclm_warn("boost.version" "Could not locate Boost include directory. Now searching the system.")
      else()
        oclm_warn("boost.version" "Could not locate Boost include directory in ${BOOST_INCLUDE_DIR}. Now searching the system.")
      endif()
      ...
      if(${BOOST_VERSION_HPP} STREQUAL BOOST_VERSION_HPP-NOTFOUND)
        if(NOT BOOST_INCLUDE_DIR)
          oclm_error("boost.version" "Failed to locate Boost include directory in the default path. Try setting BOOST_ROOT to your Boost installation directory.")
        else()
          oclm_error("boost.version" "Failed to locate Boost include directory in ${BOOST_INCLUDE_DIR} or in the default path. Try setting BOOST_ROOT to your Boost installation directory.")
        endif()
      endif()
    endif()
  ...
  oclm_info("boost.version" "Using ${BOOST_VERSION_HPP} as Boost version.hpp header.")
  ...
  if(NOT "${BOOST_VERSION_NUM}" STREQUAL "0")
    ...
    oclm_error("boost.version" "Invalid Boost version ${BOOST_VERSION_NUM}, expected format MMRRPP (i.e. 104800)")
  endif()
  ...
  oclm_info("boost.version" "Boost version is ${BOOST_VERSION_STR}.")
