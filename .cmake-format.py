  ...
  additional_commands = {
   'add_hpx_compile_test': { 'kwargs': { 'COMPONENT_DEPENDENCIES': '+',
                              ...
                              'pargs': { 'flags': ['FAILURE_EXPECTED', 'NOLIBS'],
                                         'nargs': '2+'}},
    'add_hpx_compile_test_target_dependencies': {'pargs': {'nargs': 2}},
    ...
    'add_hpx_headers_compile_test': {'pargs': {'nargs': 2}},
    ...
    'add_hpx_regression_compile_test': {'pargs': {'nargs': 2}},
    ...
    'add_hpx_test_target_dependencies': { 'kwargs': {'PSEUDO_DEPS_NAME': 1},
                                          'pargs': {'flags': [], 'nargs': '2+'}},
    'add_hpx_unit_compile_test': {'pargs': {'nargs': 2}},
    'add_hpx_unit_test': {'pargs': {'nargs': 2}},
    ...
    'add_test_and_deps_compile_test': {'pargs': {'nargs': 3}},
