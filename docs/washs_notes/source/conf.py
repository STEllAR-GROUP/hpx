...
copyright = u'2011, Bryce Lelbach aka wash'
...
latex_documents = [
  ('index', 'WashsNotesonHPXCandParalleX.tex', u'Wash\'s Notes on HPX, C++ and ParalleX Documentation',
   u'Bryce Lelbach aka wash', 'manual'),
]
