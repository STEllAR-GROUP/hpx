...
namespace optimize {
    ...
    */
    template<class string_type_ = hpx::util::logging::hold_string_type > struct cache_string_one_str {
    ...
    */
    template<class string_type_ = hpx::util::logging::hold_string_type, class ptr_type = void* > struct cache_string_several_str {
    private:
        typedef string_type_ string_type;
