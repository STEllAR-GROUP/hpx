...
namespace hpx { namespace lcos
{
    ...
    public:
        ...
        void apply(naming::id_type const& gid, Arg0 && arg0)
        {
            util::block_profiler_wrapper<deferred_packaged_task_tag> bp(apply_logger_);
            hpx::apply_c<Action>(this->get_gid(), gid, std::forward<Arg0>(arg0));
        }
    ...
    private:
        ...
        void invoke1(naming::id_type const& gid, Arg0 && arg0)
        {
            if (!((*this->impl_)->is_ready()))
                this->apply(gid, std::forward<Arg0>(arg0));
        }
    ...
    public:
        ...
        ///               with the action as the continuation parameter).
        template <typename Arg0>
        deferred_packaged_task(naming::gid_type const& gid, Arg0 && arg0)
          : apply_logger_("deferred_packaged_task::apply"),
            closure_(boost::bind(&deferred_packaged_task::template invoke1<Arg0>, this_(),
                naming::id_type(gid, naming::id_type::unmanaged), std::forward<Arg0>(arg0)))
        {
            LLCO_(info) << "deferred_packaged_task::deferred_packaged_task("
                        << hpx::actions::detail::get_action_name<Action>()
                        << ", "
        ...
        template <typename Arg0>
        deferred_packaged_task(naming::id_type const& gid, Arg0 && arg0)
          : apply_logger_("deferred_packaged_task::apply"),
            closure_(boost::bind(&deferred_packaged_task::template invoke1<Arg0>, this_(), gid, std::forward<Arg0>(arg0)))
        {
            LLCO_(info) << "deferred_packaged_task::deferred_packaged_task("
                        << hpx::actions::detail::get_action_name<Action>()
                        << ", "
    ...
    public:
        ...
        void apply(naming::id_type const& gid, Arg0 && arg0)
        {
            ...
            if (agas::is_local_address_cached(gid, addr)) {
                ...
                // remote execution
                hpx::applier::detail::apply_c<Action>(addr, this->get_gid(), gid, std::forward<Arg0>(arg0));
            }
        }
    ...
    private:
        ...
        {
            if (!((*th->impl_)->is_ready()))
                th->apply(gid, std::forward<Arg0>(arg0));
        }
    ...
    public:
        ...
        deferred_packaged_task(naming::id_type const& gid, Arg0 && arg0)
          : apply_logger_("deferred_packaged_task_direct::apply"),
            closure_(boost::bind(&deferred_packaged_task::template invoke1<Arg0>, this, gid, std::forward<Arg0>(arg0)))
        {
            LLCO_(info) << "deferred_packaged_task::deferred_packaged_task("
                        << hpx::actions::detail::get_action_name<Action>()
                        << ", "
