...
void function_test()
{
    ...
    HPX_TEST( test( hpx::util::bind(f_6, placeholders::_1, 2, 3, 4, 5, 6), i ) == 654321L );
    HPX_TEST( test( hpx::util::bind(f_7, placeholders::_1, 2, 3, 4, 5, 6, 7), i ) == 7654321L );
    HPX_TEST( test( hpx::util::bind(f_8, placeholders::_1, 2, 3, 4, 5, 6, 7, 8), i ) == 87654321L );
    HPX_TEST( test( hpx::util::bind(f_9, placeholders::_1, 2, 3, 4, 5, 6, 7, 8, 9), i ) == 987654321L );
    ...
    HPX_TEST( testv( hpx::util::bind(fv_5, placeholders::_1, 2, 3, 4, 5), i ) == 54321L );
    HPX_TEST( testv( hpx::util::bind(fv_6, placeholders::_1, 2, 3, 4, 5, 6), i ) == 654321L );
    HPX_TEST( testv( hpx::util::bind(fv_7, placeholders::_1, 2, 3, 4, 5, 6, 7), i ) == 7654321L );
    HPX_TEST( testv( hpx::util::bind(fv_8, placeholders::_1, 2, 3, 4, 5, 6, 7, 8), i ) == 87654321L );
    HPX_TEST( testv( hpx::util::bind(fv_9, placeholders::_1, 2, 3, 4, 5, 6, 7, 8, 9), i ) == 987654321L );
}
