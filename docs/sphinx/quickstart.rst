...
.. code-block:: cmake
   ...
   target_link_libraries(my_hpx_program HPX::hpx HPX::wrap_main hpx::iostream_component)
...
.. note::
   ...
   * ``hpx::iostream_component`` is optional for a minimal project but lets us
...
.. caution::
   ...
   prevent encountering an error indicating that the ``hpx::iostream_component``
   target is not found.
