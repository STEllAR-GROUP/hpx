...
#if defined(HPX_MSVC)
#pragma message("The header hpx/local/task_block.hpp is deprecated, " \
    "please include hpx/task_block.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/local/task_block.hpp is deprecated, " \
    "please include hpx/task_block.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
