...
#if defined(HPX_MSVC)
#pragma message("The header hpx/local/source_location.hpp is deprecated, " \
    "please include hpx/source_location.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/local/source_location.hpp is deprecated, " \
    "please include hpx/source_location.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
