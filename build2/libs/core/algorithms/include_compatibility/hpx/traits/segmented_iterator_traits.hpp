...
#if defined(HPX_MSVC)
#pragma message("The header hpx/traits/segmented_iterator_traits.hpp is deprecated, " \
    "please include hpx/algorithms/traits/segmented_iterator_traits.hpp instead." \
