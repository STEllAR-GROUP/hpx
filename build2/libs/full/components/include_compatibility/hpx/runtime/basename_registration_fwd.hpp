...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/basename_registration_fwd.hpp is deprecated, " \
    "please include hpx/modules/components.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/runtime/basename_registration_fwd.hpp is deprecated, " \
    "please include hpx/modules/components.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
