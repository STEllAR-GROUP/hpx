...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/actions/detail/invocation_count_registry.hpp is deprecated, " \
    "please include hpx/modules/actions_base.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/runtime/actions/detail/invocation_count_registry.hpp is deprecated, " \
    "please include hpx/modules/actions_base.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
