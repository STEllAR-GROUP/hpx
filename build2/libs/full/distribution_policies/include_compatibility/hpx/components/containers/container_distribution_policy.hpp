...
#if defined(HPX_MSVC)
#pragma message("The header hpx/components/containers/container_distribution_policy.hpp is deprecated, " \
    "please include hpx/modules/distribution_policies.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/components/containers/container_distribution_policy.hpp is deprecated, " \
    "please include hpx/modules/distribution_policies.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
