...
#if defined(HPX_MSVC)
#pragma message("The header hpx/util/functional/colocated_helpers.hpp is deprecated, " \
    "please include hpx/async_colocated/functional/colocated_helpers.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/util/functional/colocated_helpers.hpp is deprecated, " \
    "please include hpx/async_colocated/functional/colocated_helpers.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
