...
#if defined(HPX_MSVC)
#pragma message("The header hpx/parallel/executors/distribution_policy_executor.hpp is deprecated, " \
    "please include hpx/modules/executors_distributed.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/parallel/executors/distribution_policy_executor.hpp is deprecated, " \
    "please include hpx/modules/executors_distributed.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
