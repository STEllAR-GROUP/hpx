...
#if !defined(HPX_PREPROCESSED_LCOS_ASYNC_FWD_HPP)
#define HPX_PREPROCESSED_LCOS_ASYNC_FWD_HPP
...
#elif HPX_LIMIT <= 15
#include <hpx/lcos/preprocessed/async_fwd_15.hpp>
#elif HPX_LIMIT <= 20
#include <hpx/lcos/preprocessed/async_fwd_20.hpp>
/*
#elif HPX_LIMIT <= 25
#include <hpx/lcos/preprocessed/async_fwd_25.hpp>
#elif HPX_LIMIT <= 30
#include <hpx/lcos/preprocessed/async_fwd_30.hpp>
#elif HPX_LIMIT <= 35
#include <hpx/lcos/preprocessed/async_fwd_35.hpp>
#elif HPX_LIMIT <= 40
#include <hpx/lcos/preprocessed/async_fwd_40.hpp>
#elif HPX_LIMIT <= 45
#include <hpx/lcos/preprocessed/async_fwd_45.hpp>
#elif HPX_LIMIT <= 50
