...
#if !defined(HPX_LCOS_EAGER_FUTURE_ROUTE_JUN_27_2008_0420PM)
#define HPX_LCOS_EAGER_FUTURE_ROUTE_JUN_27_2008_0420PM
...
namespace hpx { namespace lcos
{
    ...
    class eager_future_route;

    ///////////////////////////////////////////////////////////////////////////
    template <typename Action, typename Result>
    class eager_future_route<Action, Result, non_signalling_tag_route, boost::mpl::false_>
    ...
    public:
        ...
        eager_future_route(naming::gid_type const& gid, threads::thread_priority priority)
          : apply_logger_("eager_future::apply")
        {
            LLCO_(info) << "eager_future::eager_future("
                        << hpx::actions::detail::get_action_name<Action>()
        ...
        eager_future_route(naming::id_type const& gid, threads::thread_priority priority)
          : apply_logger_("eager_future::apply")
        {
            LLCO_(info) << "eager_future::eager_future("
                        << hpx::actions::detail::get_action_name<Action>()
        ...
        ///               with the action as the continuation parameter).
        template <typename Arg0>
        eager_future_route(naming::gid_type const& gid, Arg0 const& arg0)
          : apply_logger_("eager_future::apply")
        {
            LLCO_(info) << "eager_future::eager_future("
                        << hpx::actions::detail::get_action_name<Action>()
        ...
        template <typename Arg0>
        eager_future_route(naming::id_type const& gid, Arg0 const& arg0)
          : apply_logger_("eager_future::apply")
        {
            LLCO_(info) << "eager_future::eager_future("
                        << hpx::actions::detail::get_action_name<Action>()
        ...
        #include <hpx/lcos/eager_future_route_constructors.hpp>
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename Action, typename Result>
    class eager_future_route<Action, Result, non_signalling_tag_route, boost::mpl::true_>
      : public promise<Result, typename Action::result_type>
    {
    private:
        typedef promise<Result, typename Action::result_type> base_type;
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename Action, typename Result>
    class eager_future_route<Action, Result, signalling_tag_route, boost::mpl::false_>
    ...
    public:
        ...
        /// this instance its member function \a apply needs to be directly
        /// called.
        eager_future_route(completed_callback_type const& data_sink,
        ...
        // pull in remaining constructors
        #include <hpx/lcos/eager_future_route_signalling_constructors.hpp>
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename Action, typename Result>
    class eager_future_route<Action, Result, signalling_tag_route, boost::mpl::true_>
      : public signalling_promise<Result, typename Action::result_type>
    {
    private:
        typedef signalling_promise<Result, typename Action::result_type> base_type;
    ...
    public:
        ...
        // pull in remaining constructors
        #include <hpx/lcos/eager_future_route_signalling_constructors_direct.hpp>
