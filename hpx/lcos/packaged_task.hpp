...
namespace hpx { namespace lcos
{
    ...
    public:
        ...
        packaged_task(naming::gid_type const& gid, threads::thread_priority priority)
          : apply_logger_("packaged_task::apply")
        {
            LLCO_(info) << "packaged_task::packaged_task("
                        << hpx::actions::detail::get_action_name<action_type>()
        ...
        packaged_task(naming::id_type const& gid, threads::thread_priority priority)
          : apply_logger_("packaged_task::apply")
        {
            LLCO_(info) << "packaged_task::packaged_task("
                        << hpx::actions::detail::get_action_name<action_type>()
        ...
        ///               with the action as the continuation parameter).
        template <typename Arg0>
        packaged_task(naming::gid_type const& gid, BOOST_FWD_REF(Arg0) arg0)
          : apply_logger_("packaged_task::apply")
        {
            LLCO_(info) << "packaged_task::packaged_task("
                        << hpx::actions::detail::get_action_name<action_type>()
        ...
        template <typename Arg0>
        packaged_task(naming::id_type const& gid, BOOST_FWD_REF(Arg0) arg0)
          : apply_logger_("packaged_task::apply")
        {
            LLCO_(info) << "packaged_task::packaged_task("
                        << hpx::actions::detail::get_action_name<action_type>()
    ...
    public:
        ...
        // pull in remaining constructors
        #include <hpx/lcos/packaged_task_signalling_constructors.hpp>
    ...
    public:
        ...
        // pull in remaining constructors
        #include <hpx/lcos/packaged_task_signalling_constructors_direct.hpp>
