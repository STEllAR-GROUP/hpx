...
namespace hpx { namespace parallel { HPX_INLINE_NAMESPACE(v1)
{
    ...
    ///
    /// \note   Complexity: Exactly \code distance(first, last) \endcode
    ///                     invocations of \code f() \endcode and assignments
    ///
    ...
    ///                     function should be equivalent to the following: \code
    ///                     Ret fun(); \endcode.
    ///
    ...
    ///
    /// \note   Complexity: Exactly \code distance(first, next(first,count)) \endcode
    ///         invocations of \code g() \endcode and assignments.
    ///
    /// \tparam ExPolicy    The type of the execution policy to use (deduced).
    ///                     It describes the manner in which the execution
    ///                     of the algorithm may be parallelized and the manner
    ...
    ///                     called. The signature of the function should be equivalent
    ///                     to \code Ret fun(); \endcode.
    ///
