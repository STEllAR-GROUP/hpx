...
namespace hpx { namespace parallel { HPX_INLINE_NAMESPACE(v3)
{
    ...
    ///                     (default: 1).
    ///
    typedef threads::executors::local_queue_os_executor local_queue_os_executor;
#endif
    ...
    ///                     (default: 1).
    ///
    typedef threads::executors::static_queue_os_executor static_queue_os_executor;
#endif
    ...
    ///                     (default: 1).
    ///
    typedef threads::executors::local_priority_queue_os_executor
    ...
    ///                     (default: 1).
    ///
    typedef threads::executors::static_priority_queue_os_executor
