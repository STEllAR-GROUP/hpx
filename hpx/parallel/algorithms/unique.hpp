...
namespace hpx { namespace parallel { inline namespace v1
{
    ...
    namespace detail
    {
        ...
        >::type
        unique_copy_helper(ExPolicy && policy, FwdIter1 first, FwdIter1 last,
    ...
    namespace detail
    {
        ...
        struct unique : public detail::algorithm<unique<Iter>, Iter>
        {
                ...
                Pred && pred, Proj && proj)
            {
                ...
                hpx::future<FwdIter> result = execution::async_execute(
                    policy.executor(),
                    [&policy, &pred, &proj, first, last]() -> FwdIter
                    {
