...
namespace hpx { namespace parallel { namespace util
{
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE
    typename std::enable_if<
       !is_datapar_execution_policy<ExPolicy>::value, std::pair<Begin1, Begin2>
    >::type
    ...
    namespace detail
    {
        ...
        HPX_HOST_DEVICE HPX_FORCEINLINE
        typename std::enable_if<
            !is_datapar_execution_policy<ExPolicy>::value, T const&
        >::type
        ...
        HPX_HOST_DEVICE HPX_FORCEINLINE
        typename std::enable_if<
            !is_datapar_execution_policy<ExPolicy>::value, T
        >::type
