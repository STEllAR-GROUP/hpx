...
#if !defined(HPX_COMPONENTS_DISTRIBUTED_LIST_MAY_18_2008_0822AM)
#define HPX_COMPONENTS_DISTRIBUTED_LIST_MAY_18_2008_0822AM
...
{
    ///////////////////////////////////////////////////////////////////////////
    /// The \a distributed_list class is the client side representation of a
    /// specific \a server#distributed_list component
    ///
    ...
    class distributed_list
      : public client_base<
                   distributed_list<List>, stubs::distributed_list<List>
               >
    {
    private:
        typedef client_base<
    ...
    public:
        distributed_list(naming::id_type gid, bool freeonexit = true)
