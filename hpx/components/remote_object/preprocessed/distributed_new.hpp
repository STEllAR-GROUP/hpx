...
#if !defined(HPX_PREPROCESSED_COMPONENTS_REMOTE_OBJECT_DISTRIBUTED_NEW_HPP)
#define HPX_PREPROCESSED_COMPONENTS_REMOTE_OBJECT_DISTRIBUTED_NEW_HPP
...
#elif HPX_LIMIT <= 15
#include <hpx/components/remote_object/preprocessed/distributed_new_15.hpp>
#elif HPX_LIMIT <= 20
#include <hpx/components/remote_object/preprocessed/distributed_new_20.hpp>
/*
#elif HPX_LIMIT <= 25
#include <hpx/components/remote_object/preprocessed/distributed_new_25.hpp>
#elif HPX_LIMIT <= 30
#include <hpx/components/remote_object/preprocessed/distributed_new_30.hpp>
#elif HPX_LIMIT <= 35
#include <hpx/components/remote_object/preprocessed/distributed_new_35.hpp>
#elif HPX_LIMIT <= 40
#include <hpx/components/remote_object/preprocessed/distributed_new_40.hpp>
#elif HPX_LIMIT <= 45
#include <hpx/components/remote_object/preprocessed/distributed_new_45.hpp>
#elif HPX_LIMIT <= 50
