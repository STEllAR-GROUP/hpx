...
#if !defined(HPX_COMPONENTS_AMR_FUNCTIONAL_COMPONENT_5_OCT_21_2008_1217PM)
#define HPX_COMPONENTS_AMR_FUNCTIONAL_COMPONENT_5_OCT_21_2008_1217PM
...
namespace hpx { namespace components { namespace amr { namespace server 
{
    ///////////////////////////////////////////////////////////////////////////
    template <>
    class functional_component<5>
      : public simple_component_base<functional_component<5> >
    {
    public:
        ...
        // component
        typedef amr::server::functional_component<5> wrapping_type;
        ...
        threads::thread_state eval_nv(threads::thread_self& self, 
            ...
            naming::id_type const& gid3, naming::id_type const& gid4, 
            naming::id_type const& gid5)
        {
            return eval(self, appl, result, gid1, gid2, gid3, gid4, gid5);
        }
