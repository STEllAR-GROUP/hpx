...
namespace hpx{ namespace traits 
{
    ...
    template <typename T, typename Enable> 
     std::size_t argument_size<T, Enable>::call(T const& t)
    {
        return sizeof(T);
    } 
    ...
    struct argument_size<T,                                                            
        typename boost::enable_if<boost::spirit::traits::is_container<T> >::type>
    {                                                                                
    ...
    struct get_size
    {
        ...
        template<typename T>                                                         
        std::size_t operator()(std::size_t const& size, T const& t) const            
        {                                                                            
    ...
    {                                                                            
        ...
        {                                                                            
            ...
            sum+= boost::fusion::accumulate(v, sum, get_size());
            return sum;
        }
    };
}}

#endif //HPX_giMcvwgb6F6ljtAzZHfS99KSE6gn3KnvWt1TgTfV
