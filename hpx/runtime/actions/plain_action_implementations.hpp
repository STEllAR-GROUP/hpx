...
#define HPX_GUID_ARGUMENT2(z, n, data) (BOOST_PP_CAT(T, n))
    ...
    public:
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(N, Arg, const& arg)) 
        {
            return construct_continuation_thread_function(
                boost::bind(F, boost::ref(appl), _1, BOOST_PP_ENUM_PARAMS(N, arg)), 
                appl, cont);
        }
    ...
    template <
        ...
        threads::thread_state (*F)(applier::applier&, Result*, 
            BOOST_PP_ENUM_PARAMS(N, T)),
        Result (*DirectF)(applier::applier&, BOOST_PP_ENUM_PARAMS(N, T))
    >
    ...
    public:
        ...
        static Result execute_function(
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(N, Arg, const& arg))
        {
            return (*DirectF)(appl, BOOST_PP_ENUM_PARAMS(N, arg));
        }
    ...
    template <
        BOOST_PP_ENUM_PARAMS(N, typename T),
        threads::thread_state (*F)(applier::applier&, BOOST_PP_ENUM_PARAMS(N, T))
    >
    ...
    public:
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(N, Arg, const& arg)) 
        {
            return base_type::construct_continuation_thread_function(
                boost::bind(F, boost::ref(appl), BOOST_PP_ENUM_PARAMS(N, arg)), 
                appl, cont);
        }
    ...
    template <
        BOOST_PP_ENUM_PARAMS(N, typename T),
        threads::thread_state (*F)(applier::applier&, BOOST_PP_ENUM_PARAMS(N, T)),
        void (*DirectF)(applier::applier&, BOOST_PP_ENUM_PARAMS(N, T))
    >
    ...
    public:
        ...
        static void execute_function(
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(N, Arg, const& arg))
        {
            (*DirectF)(appl, BOOST_PP_ENUM_PARAMS(N, arg));
        }
