...
#include BOOST_PP_ITERATE()
        ...
        BOOST_FWD_REF(Arguments) args)
    {
        ...
        return construct_continuation_thread_function_voidN<
    ...
    {
        typedef typename boost::remove_reference<Arguments>::type arguments_type;
        return construct_continuation_thread_functionN<
                boost::fusion::result_of::size<arguments_type>::value>::call(
            cont, boost::forward<Func>(func), boost::forward<Arguments>(args));
    }
...
#define HPX_ACTION_DIRECT_ARGUMENT(z, n, data)                                \
    ...
    template <>
    struct construct_continuation_thread_function_voidN<N>
    {
        template <typename Func, typename Arguments>
        static HPX_STD_FUNCTION<threads::thread_function_type>
    ...
    template <>
    struct construct_continuation_thread_functionN<N>
    {
        template <typename Func, typename Arguments>
        static HPX_STD_FUNCTION<threads::thread_function_type>
        call(continuation_type cont, BOOST_FWD_REF(Func) func,
