...
//       : public actions::plain_action3<logging_destination, int, 
//             std::string const&, console_logging, threads::thread_priority_low, 
//             console_logging_action>
//     {
//     private:
//         typedef actions::plain_action3<logging_destination, int, 
//             std::string const&, console_logging, threads::thread_priority_low, 
//             console_logging_action> 
//         base_type;
// 
