...
namespace hpx { namespace components { namespace stubs
{
    struct HPX_EXPORT memory
    {
        ...
        ///////////////////////////////////////////////////////////////////////
        static hpx::future<boost::uint8_t> load8(id_type const& id);
        static boost::uint8_t load8(launch::sync_policy, id_type const& id,
            error_code& ec = throws);

        static hpx::future<boost::uint16_t> load16(id_type const& id);
        static boost::uint16_t load16(launch::sync_policy, id_type const& id,
            error_code& ec = throws);

        static hpx::future<boost::uint32_t> load32(id_type const& id);
        static boost::uint32_t load32(launch::sync_policy, id_type const& id,
            error_code& ec = throws);

        static hpx::future<boost::uint64_t> load64(id_type const& id);
        static boost::uint64_t load64(launch::sync_policy, id_type const& id,
            error_code& ec = throws);
        ...
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static void store8_async(id_type const& id, boost::uint8_t value)
        {
            store8(launch::apply, id, value);
        }
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static void store8_sync(id_type const& id, boost::uint8_t value,
            error_code& ec = throws)
        {
        ...
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static void store16_async(id_type const& id, boost::uint16_t value)
        {
            store16(launch::apply, id, value);
        }
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static void store16_sync(id_type const& id, boost::uint16_t value,
            error_code& ec = throws)
        {
        ...
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static void store32_async(id_type const& id, boost::uint32_t value)
        {
            store32(launch::apply, id, value);
        }
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static void store32_sync(id_type const& id, boost::uint32_t value,
            error_code& ec = throws)
        {
        ...
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static void store64_async(id_type const& id, boost::uint64_t value)
        {
            store64(launch::apply, id, value);
        }
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static void store64_sync(id_type const& id, boost::uint64_t value,
            error_code& ec = throws)
        {
        ...
        ///////////////////////////////////////////////////////////////////////
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static boost::uint8_t load8_sync(id_type const& id,
            error_code& ec = throws)
        {
        ...
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static boost::uint16_t load16_sync(id_type const& id,
            error_code& ec = throws)
        {
        ...
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static boost::uint32_t load32_sync(id_type const& id,
            error_code& ec = throws)
        {
        ...
        HPX_DEPRECATED(HPX_DEPRECATED_MSG)
        static boost::uint64_t load8_sync(id_type const& id,
            error_code& ec = throws)
        {
