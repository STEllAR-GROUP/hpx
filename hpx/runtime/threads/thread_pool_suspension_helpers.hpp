...
namespace hpx { namespace threads {
    ...
    ///          has been resumed.
    HPX_EXPORT hpx::future<void> resume_processing_unit(
    ...
    HPX_EXPORT hpx::future<void> suspend_processing_unit(
        thread_pool_base& pool, std::size_t virt_core);
    ...
    ///
    /// \throws hpx::exception if called from outside the HPX runtime.
    HPX_EXPORT hpx::future<void> resume_pool(thread_pool_base& pool);
    ...
    ///
    /// \throws hpx::exception if called from outside the HPX runtime.
    HPX_EXPORT hpx::future<void> suspend_pool(thread_pool_base& pool);
