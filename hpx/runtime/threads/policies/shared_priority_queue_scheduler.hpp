...
#if !defined(HPX_THREADMANAGER_SCHEDULING_SHARED_PRIORITY_QUEUE_MAR_15_2011_0926AM)
#define HPX_THREADMANAGER_SCHEDULING_SHARED_PRIORITY_QUEUE_MAR_15_2011_0926AM
...
namespace hpx { namespace threads { namespace policies
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    /// The shared_priority_queue_scheduler maintains exactly one queue of work
    ...
    class HPX_EXPORT shared_priority_queue_scheduler : public scheduler_base
    {
    protected:
    ...
    public:
        ...
        struct init_parameter
        {
            init_parameter()
              : num_queues_(1),
                ...
                numa_sensitive_(0),
                description_("shared_priority_queue_scheduler")
            {}
        ...
        shared_priority_queue_scheduler(init_parameter_type const& init,
