...
namespace tag { struct tcp_ip_protocol; }

namespace traits // hpx::agas::traits
{

template <>
struct protocol_name_hook<tag::tcp_ip_protocol>
{
...
template <>
struct locality_type<tag::tcp_ip_protocol>
{ typedef boost::asio::ip::tcp::endpoint type; };

} // hpx::agas::traits

typedef local_address<tag::tcp_ip_protocol> tcp_ip_local_address;
...
typedef primary_namespace_type<hpx::agas::tag::tcp_ip_protocol>::type
    tcp_ip_primary_namespace;
typedef locality_namespace_type<hpx::agas::tag::tcp_ip_protocol>::type
