...
#define HPX_PLUGIN_FORCE_LOAD_NAME(name, base)                                \
    BOOST_PP_CAT(                                                             \
        BOOST_PP_CAT(HPX_PLUGIN_PREFIX, _exported_plugins_force_load_),       \
        HPX_PLUGIN_NAME_2(name, base))                                        \
    /**/
