...
#define HPX_UTIL_BOUND_ACTION_APPLY_ASYNC(Z, N, D)                            \
namespace hpx {                                                               \
    template <                                                                \
        typename Action                                                       \
    ...
    {                                                                         \
        return bound.apply(BOOST_PP_ENUM(N, HPX_UTIL_BIND_FWD_PARAMS, A));    \
    }                                                                         \
    template <                                                                \
        typename Action                                                       \
      BOOST_PP_COMMA_IF(NN) BOOST_PP_ENUM_PARAMS(NN, typename T)              \
    ...
    {                                                                         \
        return bound.async(BOOST_PP_ENUM(N, HPX_UTIL_BIND_FWD_PARAMS, A));    \
    }                                                                         \
}                                                                             \
    /**/
...
BOOST_PP_REPEAT_FROM_TO(
    1
  , HPX_FUNCTION_LIMIT
  , HPX_UTIL_BOUND_ACTION_APPLY_ASYNC, _
)

#undef HPX_UTIL_BOUND_ACTION_APPLY_ASYNC
