...
#define HPX_USE_LOG_FIND_GATHER(name,log_type,base_type) \
    namespace hpx { namespace util { namespace logging { namespace log_define_ { \
        extern ::hpx::util::logging::detail::log_keeper< base_type, name ## _HPX_LOG_impl_, ::hpx::util::logging::detail::call_write_logger_finder< log_type, gather_msg > ::type > name ; \
    }}}} \
    using hpx { namespace util_log_define_:: name ;


#define HPX_USE_LOG(name,type) HPX_USE_LOG_FIND_GATHER(name, type, ::hpx::util::logging::detail::fast_compile_with_default_gather<>::log_type )

#define HPX_DECLARE_LOG_KEEPER(name,log_type) \
    namespace hpx { namespace util { namespace logging { namespace log_declare_ { \
        extern ::hpx::util::logging::detail::log_keeper< log_type, name ## _HPX_LOG_impl_ > name; \
    }}}} \
...
#define HPX_DECLARE_LOG_FIND_GATHER(name) \
    HPX_DECLARE_LOG_WITH_LOG_TYPE(name, ::hpx::util::logging::detail::fast_compile_with_default_gather<>::log_type )

#define HPX_DECLARE_LOG(name,type) HPX_DECLARE_LOG_FIND_GATHER(name)

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// define log
#define HPX_DEFINE_LOG_FIND_GATHER(name, log_type, base_type, gather_msg)  base_type & name ## _HPX_LOG_impl_() \
{ typedef ::hpx::util::logging::detail::call_write_logger_finder< log_type, gather_msg > ::type logger_type; \
  static logger_type i; return i; } \
    namespace { hpx::util::logging::detail::fake_using_log ensure_log_is_created_before_main ## name ( name ## _HPX_LOG_impl_() ); } \
    namespace hpx { namespace util_log_declare_ { \
    ::hpx::util::logging::detail::log_keeper< base_type, name ## _HPX_LOG_impl_ > name ; \
    } \
    namespace hpx { namespace util_log_define_ { \
    ::hpx::util::logging::detail::log_keeper< base_type, name ## _HPX_LOG_impl_, ::hpx::util::logging::detail::call_write_logger_finder< log_type, gather_msg > ::type > name ; \
    } \
    using hpx { namespace util_log_define_ :: name ;

#define HPX_DEFINE_LOG(name,type) \
    HPX_DEFINE_LOG_FIND_GATHER(name, type, ::hpx::util::logging::detail::fast_compile_with_default_gather<>::log_type, ::hpx::util::logging::detail::fast_compile_with_default_gather<>::gather_msg )

#else
// don't compile fast

#define HPX_DECLARE_LOG(name,type) type& name ## _HPX_LOG_impl_(); extern hpx::util::logging::detail::log_keeper<type, name ## _HPX_LOG_impl_ > name;
...
#define HPX_DECLARE_LOG_FILTER_NO_NAMESPACE_PREFIX(name,type) type& name ## _HPX_LOG_filter_impl_(); extern hpx::util::logging::detail::log_filter_keeper<type, name ## _HPX_LOG_filter_impl_ > name;
#define HPX_DEFINE_LOG_FILTER_NO_NAMESPACE_PREFIX(name,type)  type& name ## _HPX_LOG_filter_impl_() \
    { static type i; return i; } \
    namespace { hpx::util::logging::detail::fake_using_log ensure_log_is_created_before_main ## name ( name ## _HPX_LOG_filter_impl_() ); } \
    hpx::util::logging::detail::log_filter_keeper<type, name ## _HPX_LOG_filter_impl_ > name;


#define HPX_DECLARE_LOG_FILTER(name,type) HPX_DECLARE_LOG_FILTER_NO_NAMESPACE_PREFIX(name, ::hpx::util::logging:: type)

#define HPX_DEFINE_LOG_FILTER(name,type) HPX_DEFINE_LOG_FILTER_NO_NAMESPACE_PREFIX(name, ::hpx::util::logging:: type)

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Log Macros

#define HPX_LOG_USE_LOG(l, do_func, is_log_enabled) if ( !(is_log_enabled) ) ; else l -> do_func
...
#define HPX_LOG_USE_SIMPLE_LOG_IF_FILTER(l, is_log_enabled) if ( !(is_log_enabled) ) ; else l ->operator()
