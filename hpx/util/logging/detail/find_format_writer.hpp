...
namespace detail {
    ...
    template<class string, class formatter_base, class destination_base, class lock_resource> struct find_format_write_params {
        typedef typename ::hpx::util::logging::format_and_write::simple<string> apply_format_and_write ;
        typedef typename ::hpx::util::logging::msg_route::simple<formatter_base, destination_base, lock_resource> router_type;
    };

    template<class string_type, class formatter_base, class destination_base, class lock_resource>
        struct find_format_write_params< typename hpx::util::logging::optimize::cache_string_several_str<string_type>, formatter_base, destination_base, lock_resource>
    {
        typedef typename hpx::util::logging::optimize::cache_string_several_str<string_type> cache_string;
        typedef typename hpx::util::logging::format_and_write::use_cache<formatter_base, destination_base, cache_string> apply_format_and_write ;

        typedef hpx::util::logging::array::shared_ptr_holder<formatter_base, hpx::util::logging::threading::mutex > formatter_array ;
        typedef hpx::util::logging::array::shared_ptr_holder<destination_base, hpx::util::logging::threading::mutex > destination_array ;
    ...
    template<class format_write> struct find_writer_with_thread_safety<hpx::util::logging::writer::threading::no_ts,format_write> {
        typedef format_write type;
    };

    template<class format_write> struct find_writer_with_thread_safety<hpx::util::logging::writer::threading::ts_write,format_write> {
        typedef writer::ts_write<format_write> type;
    };

    template<class format_write> struct find_writer_with_thread_safety<hpx::util::logging::writer::threading::on_dedicated_thread,format_write> {
...
namespace detail {
    template< class format_base_type , class destination_base_type , class lock_resource, class thread_safety > struct format_find_writer {
        ...
        typedef typename ::hpx::util::logging::formatter::msg_type<override_>::type format_msg_type;
        typedef typename ::hpx::util::logging::destination::msg_type<override_>::type destination_msg_type;
        typedef typename ::hpx::util::logging::types<override_>::lock_resource default_lock_resource;

        typedef ::hpx::util::logging::formatter::base< default_, default_ > default_format_base;
        typedef ::hpx::util::logging::destination::base< default_, default_ > default_destination_base;
        ...
        typedef ::hpx::util::logging::array::shared_ptr_holder<format_base, hpx::util::logging::threading::mutex > formatter_array ;
        typedef ::hpx::util::logging::array::shared_ptr_holder<destination_base, hpx::util::logging::threading::mutex > destination_array ;
