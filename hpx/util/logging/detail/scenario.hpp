...
namespace usage {
    ...
    */
    ...
    namespace detail_find_logger {
        ...
        template<> struct find_gather<gather_usage::ostream_like> { typedef ::hpx::util::logging::default_ type; };
        ...
        template<class favor_, int period_secs, class gather> struct find_logger< favor_, change::often<period_secs>, gather > {
            ...
            template<int secs> struct lock_resource : ::hpx::util::logging::lock_resource_finder::tss_with_cache<secs> {};

            typedef ::hpx::util::logging::logger_format_write < default_, default_, threading_type, gather, lock_resource<period_secs> > type;
        };

        template<class favor_, class gather> struct find_logger< favor_, change::set_once_when_one_thread, gather > {
            typedef typename find_threading_from_favor<favor_>::type threading_type;
            typedef ::hpx::util::logging::lock_resource_finder::single_thread lock_resource;

            typedef ::hpx::util::logging::logger_format_write< default_, default_, threading_type, gather, lock_resource> type;
        };

        template<class favor_, class gather> struct find_logger< favor_, change::set_once_when_multiple_threads, gather > {
            typedef typename find_threading_from_favor<favor_>::type threading_type;
            typedef ::hpx::util::logging::lock_resource_finder::tss_once_init<> lock_resource;
...
namespace ts {
    ...
    namespace detail {
        ...
        template<> struct find_filter<filter_::none, level_::no_levels > { typedef ::hpx::util::logging::filter::no_ts type; };
        template<> struct find_filter<filter_::use_tss, level_::no_levels> { typedef  ::hpx::util::logging::filter::use_tss_with_cache<5> type; };
        template<> struct find_filter<filter_::ts, level_::no_levels> { typedef ::hpx::util::logging::filter::ts type; };

        template<> struct find_filter<filter_::none, level_::use_levels > { typedef ::hpx::util::logging::level::holder_no_ts type; };
        template<> struct find_filter<filter_::use_tss, level_::use_levels > { typedef ::hpx::util::logging::level::holder_tss_with_cache<5> type; };
        template<> struct find_filter<filter_::ts, level_::use_levels > { typedef ::hpx::util::logging::level::holder_ts type; };

        template<logger_::type> struct find_logger {};
        template<> struct find_logger<logger_::none> {
            typedef ::hpx::util::logging::lock_resource_finder::single_thread lock_resource;
            typedef ::hpx::util::logging::logger_format_write< default_, default_, th::no_ts, default_, lock_resource > type ;
        };
        template<> struct find_logger<logger_::use_tss> {
            typedef ::hpx::util::logging::lock_resource_finder::tss_with_cache<> lock_resource;

            typedef ::hpx::util::logging::logger_format_write< default_, default_, th::ts_write, default_, lock_resource > type ;
        };
