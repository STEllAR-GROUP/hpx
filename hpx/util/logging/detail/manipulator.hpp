...
#include <hpx/util/logging/detail/forward_constructor.hpp> // HPX_LOGGING_FORWARD_CONSTRUCTOR_WITH_NEW
...
In your @ref hpx::util::logging::writer::format_write "format_write" object, you can have several formatters and destinations.
...
The default formatter %base class is computed based on your usage of the @ref HPX_LOG_FORMAT_MSG macro:
...
The default destination %base class is computed based on your usage of the @ref HPX_LOG_DESTINATION_MSG macro:
...
Now, you will define your @ref logger "logger(s)", to use the @ref hpx::util::logging::writer::format_write "format_write" class:
...
namespace formatter {
    namespace detail {
        template<class arg, class ptr, class dummy = override > struct format_base_finder {
            typedef typename use_default<arg, typename hpx::util::logging::formatter::msg_type<dummy>::type > ::type arg_type;
            typedef hpx::util::logging::manipulator::base< arg_type, arg_type &, ptr> type;
        };
    }
    ...
    */
    ...
    /**
        ...
        @param op_e How will you @ref hpx::util::logging::manipulator::implement_op_equal "implement operator=="
...
namespace destination {
    namespace detail {
        template<class arg, class ptr, class dummy = override > struct destination_base_finder {
            typedef typename use_default<arg, typename hpx::util::logging::destination::msg_type<dummy>::type > ::type arg_type;
            typedef hpx::util::logging::manipulator::base< arg_type, const arg_type &, ptr> type;
        };
    }
