...
#ifndef HPX_PARCELSET_POLICIES_MPI_NEW_SENDER_HPP
#define HPX_PARCELSET_POLICIES_MPI_NEW_SENDER_HPP

namespace hpx { namespace parcelset { namespace policies { namespace mpi_new
{
    struct tag_provider
    {
