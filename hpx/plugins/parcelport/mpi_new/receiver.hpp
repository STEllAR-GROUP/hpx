...
#ifndef HPX_PARCELSET_POLICIES_MPI_NEW_RECEIVER_HPP
#define HPX_PARCELSET_POLICIES_MPI_NEW_RECEIVER_HPP
...
namespace hpx { namespace parcelset { namespace policies {
    ...
    namespace mpi { class parcelport; }
    ...
    namespace mpi_new
{
    struct receiver
    {
        ...
        receiver(mpi::parcelport & pp, memory_pool_type & chunk_pool, boost::atomic<bool> & stopped)
          : pp_(pp)
