...
namespace hpx
{
    ...
    runtime_impl<SchedulingPolicy, NotificationPolicy>::runtime_impl(
      ...
      : runtime(agas_client_, hpx_ini_file, cmdline_ini_defs),
        ...
        io_pool_(4, boost::bind(&runtime_impl::init_tss, This()),
            boost::bind(&runtime_impl::deinit_tss, This())),
        parcel_pool_(4, boost::bind(&runtime_impl::init_tss, This()),
            boost::bind(&runtime_impl::deinit_tss, This())),
        timer_pool_(4, boost::bind(&runtime_impl::init_tss, This()),
            boost::bind(&runtime_impl::deinit_tss, This())),
