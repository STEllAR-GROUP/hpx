...
#if defined(HPX_MSVC)
#pragma message(                                                               \
    "The header hpx/lcos/detail/async_unwrap_result_implementations_fwd.hpp is \
    deprecated, please include \
    hpx/async_distributed/detail/async_unwrap_result_implementations_fwd.hpp instead")
#else
#warning                                                                       \
    "The header hpx/lcos/detail/async_unwrap_result_implementations_fwd.hpp is \
    deprecated, please include \
