...
#if defined(HPX_MSVC)
#pragma message(                                                               \
    "The header hpx/runtime/applier/detail/apply_colocated.hpp is deprecated, \
    please include hpx/async_distributed/applier/detail/apply_colocated.hpp instead")
#else
#warning                                                                       \
    "The header hpx/runtime/applier/detail/apply_colocated.hpp is deprecated, \
    please include hpx/async_distributed/applier/detail/apply_colocated.hpp instead"
