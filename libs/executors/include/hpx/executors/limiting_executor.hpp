...
namespace hpx { namespace parallel { namespace execution {
    namespace experimental {
        ...
        struct limiting_executor
        {
            ...
            // --------------------------------------------------------------------
            template <typename F, typename B = BaseExecutor,
            ...
            {
                throttling_wrapper(limiting_executor const& lim,
                    BaseExecutor const& base, F&& f)
                  : limiting_(lim)
                  , f_(std::forward<F>(f))
                {
                ...
                {
                    return (base.in_flight_estimate() >=
                        limiting_.upper_threshold_);
                }
                bool exceeds_lower(BaseExecutor const& base) const
                {
                    return (
                        base.in_flight_estimate() > limiting_.lower_threshold_);
                }
...
namespace hpx { namespace parallel { namespace execution {
    ...
    // --------------------------------------------------------------------
    template <typename BaseExecutor>
    struct is_one_way_executor<experimental::limiting_executor<BaseExecutor>>
    ...
    struct is_never_blocking_one_way_executor<
        experimental::limiting_executor<BaseExecutor>>
    ...
    template <typename BaseExecutor>
    struct is_two_way_executor<experimental::limiting_executor<BaseExecutor>>
