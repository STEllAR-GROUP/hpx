...
namespace hpx::serialization {
    ...
    HPX_CORE_MODULE_EXPORT_EXTERN template <typename Derived, typename Base,
    ...
    HPX_CORE_MODULE_EXPORT_EXTERN template <typename Base, typename Derived>
    ...
    HPX_CORE_MODULE_EXPORT_EXTERN template <typename D, typename B>
