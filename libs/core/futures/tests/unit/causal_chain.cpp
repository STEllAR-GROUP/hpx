...
// Causal tracing unit test - value fulfillment path.
...
int hpx_main(hpx::program_options::variables_map& vm)
{
    ...
    std::cout << "causal_chain: starting (" << iterations << " iterations)\n"
              << std::flush;
    ...
    std::cout << "causal_chain completed (" << iterations << " iterations)\n";
