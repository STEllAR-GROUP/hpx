...
namespace hpx {
    ...
    // helper enum to distinguish special copy constructors
    enum class take_ref : std::uint8_t
    {
        yes = 0
    };
    ...
    template <typename T,
        typename = std::enable_if_t<traits::needs_reference_semantics_v<T>>>
