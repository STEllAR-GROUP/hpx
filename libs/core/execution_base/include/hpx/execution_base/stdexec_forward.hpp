...
namespace hpx::execution::experimental {
    ...
    // Domain
    HPX_CXX_CORE_EXPORT using stdexec::default_domain;
    HPX_CXX_CORE_EXPORT using stdexec::dependent_domain;
    ...
    HPX_CXX_CORE_EXPORT using stdexec::make_completion_signatures;
    ...
    // Transform sender
    HPX_CXX_CORE_EXPORT using stdexec::transform_env;
