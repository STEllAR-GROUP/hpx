...
#include <hpx/iostreams/detail/adapter/mode_adapter.hpp>
#include <hpx/iostreams/detail/adapter/output_iterator_adapter.hpp>
#include <hpx/iostreams/detail/adapter/range_adapter.hpp>
#include <hpx/iostreams/device/array.hpp>
