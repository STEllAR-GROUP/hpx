...
namespace hpx::util {
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_CXX_CORE_EXPORT HPX_CORE_EXPORT bool get_endpoint(
        std::string const& addr, std::uint16_t port,
        ::asio::ip::tcp::endpoint& ep, bool force_ipv4 = false);

    HPX_CXX_CORE_EXPORT HPX_CORE_EXPORT std::string get_endpoint_name(
        ::asio::ip::tcp::endpoint const& ep);

    ///////////////////////////////////////////////////////////////////////////
    // properly resolve a give host name to the corresponding IP address
    HPX_CXX_CORE_EXPORT HPX_CORE_EXPORT ::asio::ip::tcp::endpoint
    ...
    namespace detail {
        ...
        HPX_CXX_CORE_EXPORT using endpoint_iterator_type =
    ...
    ///        locality
    HPX_CXX_CORE_EXPORT template <typename Locality>
    ...
    HPX_CXX_CORE_EXPORT [[nodiscard]] inline detail::endpoint_iterator_type
    connect_end()
    {
        return {};
    }
