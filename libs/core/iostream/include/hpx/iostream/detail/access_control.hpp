...
namespace hpx::iostream {
    ...
    HPX_CXX_CORE_EXPORT struct public_t
    {
    };
    ...
    namespace detail {
        ...
        HPX_CXX_CORE_EXPORT template <typename U>
        ...
        //
        HPX_CXX_CORE_EXPORT template <typename T, typename Access>
    ...
    //
    HPX_CXX_CORE_EXPORT template <typename T, typename Access>
    struct access_control : detail::access_control_base<T, Access>::type
    {
