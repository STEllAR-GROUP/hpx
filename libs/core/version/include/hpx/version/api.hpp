...
namespace hpx {
    ...
    HPX_CXX_CORE_EXPORT [[nodiscard]] HPX_CORE_EXPORT std::uint8_t
    major_version();
    ...
    HPX_CXX_CORE_EXPORT [[nodiscard]] HPX_CORE_EXPORT std::uint32_t
    full_version();
    ...
    // Returns the tag.
    HPX_CXX_CORE_EXPORT [[nodiscard]] HPX_CORE_EXPORT std::string tag();
    ...
    HPX_CXX_CORE_EXPORT [[nodiscard]] HPX_CORE_EXPORT std::string copyright();
    ...
    HPX_CXX_CORE_EXPORT [[nodiscard]] HPX_CORE_EXPORT std::string build_type();
