...
namespace hpx::iterators {
    ...
    HPX_CXX_EXPORT struct no_traversal_tag
    {
    };

    HPX_CXX_EXPORT struct incrementable_traversal_tag : no_traversal_tag
    {
    };

    HPX_CXX_EXPORT struct single_pass_traversal_tag
      : incrementable_traversal_tag
    {
    };

    HPX_CXX_EXPORT struct forward_traversal_tag : single_pass_traversal_tag
    {
    };

    HPX_CXX_EXPORT struct bidirectional_traversal_tag : forward_traversal_tag
    {
    };

    HPX_CXX_EXPORT struct random_access_traversal_tag
    ...
    HPX_CXX_EXPORT template <typename Traversal>
...
namespace hpx {
    ...
    HPX_CXX_EXPORT using HPX_ITERATOR_TRAVERSAL_TAG_NS::iterators::
        bidirectional_traversal_tag;
    HPX_CXX_EXPORT using HPX_ITERATOR_TRAVERSAL_TAG_NS::iterators::
