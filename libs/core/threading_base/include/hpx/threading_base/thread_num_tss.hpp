...
namespace hpx { namespace threads { namespace detail {
    ...
    HPX_LOCAL_EXPORT std::size_t set_global_thread_num_tss(std::size_t num);
    /// Get the global thread id from thread local storage.
    HPX_LOCAL_EXPORT std::size_t get_global_thread_num_tss();
    /// Set the local thread id to thread local storage.
    HPX_LOCAL_EXPORT std::size_t set_local_thread_num_tss(std::size_t num);
    /// Get the local thread id from thread local storage.
    HPX_LOCAL_EXPORT std::size_t get_local_thread_num_tss();
    /// Set the thread pool id to thread local storage.
    HPX_LOCAL_EXPORT std::size_t set_thread_pool_num_tss(std::size_t num);
    /// Get the thread pool id from thread local storage.
    HPX_LOCAL_EXPORT std::size_t get_thread_pool_num_tss();
    ...
    HPX_LOCAL_EXPORT void set_thread_nums_tss(const thread_nums&);
    HPX_LOCAL_EXPORT thread_nums get_thread_nums_tss();
...
namespace hpx {
    ...
    HPX_LOCAL_EXPORT std::size_t get_worker_thread_num();
    ...
    /// \note   This function needs to be executed on a HPX-thread. It will
    ///         fail otherwise (it will return -1).
    HPX_LOCAL_EXPORT std::size_t get_worker_thread_num(error_code& ec);
    ...
    HPX_LOCAL_EXPORT std::size_t get_local_worker_thread_num();
    ...
    /// \note This function needs to be executed on a HPX-thread. It will fail
    ///         otherwise (it will return -1).
    HPX_LOCAL_EXPORT std::size_t get_local_worker_thread_num(error_code& ec);
    ...
    /// \note This function needs to be executed on a HPX-thread. It will fail
    ///         otherwise (it will return -1).
    HPX_LOCAL_EXPORT std::size_t get_thread_pool_num();
    ...
    /// \note This function needs to be executed on a HPX-thread. It will fail
    ///         otherwise (it will return -1).
    HPX_LOCAL_EXPORT std::size_t get_thread_pool_num(error_code& ec);
}    // namespace hpx
