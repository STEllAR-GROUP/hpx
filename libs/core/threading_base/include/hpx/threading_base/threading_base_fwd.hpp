...
namespace hpx::threads {
    ...
    HPX_CXX_EXPORT class HPX_CORE_EXPORT
        thread_data;    // forward declaration only
    HPX_CXX_EXPORT class thread_data_stackful;
    HPX_CXX_EXPORT class thread_data_stackless;
    ...
    namespace policies {
        ...
        HPX_CXX_EXPORT struct HPX_CORE_EXPORT scheduler_base;
    }
    HPX_CXX_EXPORT class HPX_CORE_EXPORT thread_pool_base;

    /// \cond NOINTERNAL
    HPX_CXX_EXPORT using thread_id_ref_type = thread_id_ref;
    HPX_CXX_EXPORT using thread_id_type = thread_id;

    HPX_CXX_EXPORT using coroutine_type = coroutines::coroutine;
    HPX_CXX_EXPORT using stackless_coroutine_type =
        coroutines::stackless_coroutine;

    HPX_CXX_EXPORT using thread_result_type =
        std::pair<thread_schedule_state, thread_id_type>;
    HPX_CXX_EXPORT using thread_arg_type = thread_restart_state;

    HPX_CXX_EXPORT using thread_function_sig =
        thread_result_type(thread_arg_type);
    HPX_CXX_EXPORT using thread_function_type =
        hpx::move_only_function<thread_function_sig>;

    HPX_CXX_EXPORT using thread_self = coroutines::detail::coroutine_self;
    HPX_CXX_EXPORT using thread_self_impl_type =
    ...
    HPX_CXX_EXPORT HPX_CORE_EXPORT
        ...
        get_self_timer_data();
    HPX_CXX_EXPORT HPX_CORE_EXPORT void set_self_timer_data(
    ...
    /// not a HPX thread).
    HPX_CXX_EXPORT HPX_CORE_EXPORT thread_data* get_self_id_data() noexcept;
    ...
    HPX_CXX_EXPORT HPX_CORE_EXPORT thread_self& get_self();
    ...
    HPX_CXX_EXPORT HPX_CORE_EXPORT thread_self_impl_type* get_ctx_ptr();

    /// The function \a get_self_ptr_checked returns a pointer to the (OS
    /// thread specific) self reference to the current HPX thread.
    HPX_CXX_EXPORT HPX_CORE_EXPORT thread_self* get_self_ptr_checked(
    ...
    HPX_CXX_EXPORT HPX_CORE_EXPORT thread_id_type get_self_id() noexcept;
    ...
    HPX_CXX_EXPORT HPX_CORE_EXPORT thread_id_type get_outer_self_id() noexcept;
    ...
    ///       being defined.
    HPX_CXX_EXPORT HPX_CORE_EXPORT thread_id_type get_parent_id() noexcept;
    ...
    ///       code was compiled with HPX_HAVE_THREAD_PARENT_REFERENCE
    ///       being defined.
    HPX_CXX_EXPORT HPX_CORE_EXPORT std::size_t get_parent_phase() noexcept;
    ...
    HPX_CXX_EXPORT HPX_CORE_EXPORT std::ptrdiff_t get_self_stacksize() noexcept;
    ...
    //a HPX thread).
    HPX_CXX_EXPORT HPX_CORE_EXPORT thread_stacksize
    get_self_stacksize_enum() noexcept;
    ...
    ///       code was compiled with HPX_HAVE_THREAD_PARENT_REFERENCE
    ///       being defined.
    HPX_CXX_EXPORT HPX_CORE_EXPORT std::uint32_t
    get_parent_locality_id() noexcept;
    ...
    HPX_CXX_EXPORT HPX_CORE_EXPORT std::uint64_t
    get_self_component_id() noexcept;
}    // namespace hpx::threads
