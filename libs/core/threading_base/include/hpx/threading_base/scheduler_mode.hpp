...
#define HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG                       \
    ...
    static inline constexpr scheduler_mode nothing_special =
        scheduler_mode::nothing_special;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode do_background_work =
        scheduler_mode::do_background_work;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode reduce_thread_priority =
        scheduler_mode::reduce_thread_priority;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode delay_exit =
        scheduler_mode::delay_exit;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode fast_idle_mode =
        scheduler_mode::fast_idle_mode;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode enable_elasticity =
        scheduler_mode::enable_elasticity;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode enable_stealing =
        scheduler_mode::enable_stealing;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode enable_stealing_numa =
        scheduler_mode::enable_stealing_numa;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode assign_work_round_robin =
        scheduler_mode::assign_work_round_robin;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode assign_work_thread_parent =
        scheduler_mode::assign_work_thread_parent;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode steal_high_priority_first =
        scheduler_mode::steal_high_priority_first;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode steal_after_local =
        scheduler_mode::steal_after_local;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode enable_idle_backoff =
        scheduler_mode::enable_idle_backoff;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
    static inline constexpr scheduler_mode default_mode =
        scheduler_mode::default_;
    HPX_DEPRECATED_V(1, 8, HPX_SCHEDULER_MODE_UNSCOPED_ENUM_DEPRECATION_MSG)
