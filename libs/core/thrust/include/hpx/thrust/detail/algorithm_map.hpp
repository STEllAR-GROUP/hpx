...
struct algorithm_map<hpx::generate_n_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::generate_n(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::remove_if_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::remove_if(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::replace_if_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::replace_if(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::partition_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::partition(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::transform_reduce_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::transform_reduce(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::find_if_not_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::find_if_not(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::stable_sort_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::stable_sort(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::stable_partition_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::stable_partition(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::partition_copy_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::partition_copy(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::remove_copy_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::remove_copy(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::remove_copy_if_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::remove_copy_if(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::replace_copy_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::replace_copy(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::replace_copy_if_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::replace_copy_if(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::reverse_copy_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::reverse_copy(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::unique_copy_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::unique_copy(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::adjacent_difference_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::adjacent_difference(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::transform_inclusive_scan_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::transform_inclusive_scan(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::transform_exclusive_scan_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::transform_exclusive_scan(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::min_element_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::min_element(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::max_element_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::max_element(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::minmax_element_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::minmax_element(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::swap_ranges_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::swap_ranges(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::uninitialized_copy_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::uninitialized_copy(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::uninitialized_copy_n_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::uninitialized_copy_n(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::uninitialized_fill_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::uninitialized_fill(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::uninitialized_fill_n_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::uninitialized_fill_n(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::set_union_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::set_union(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::set_intersection_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::set_intersection(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::set_difference_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::set_difference(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::set_symmetric_difference_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::set_symmetric_difference(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::for_each_n_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::for_each_n(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::is_sorted_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::is_sorted(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
...
struct algorithm_map<hpx::is_partitioned_t> {
    template<typename Policy, typename... Args>
    static constexpr decltype(auto) invoke(Policy&& policy, Args&&... args) {
        return ::thrust::is_partitioned(policy.get(), HPX_FORWARD(Args, args)...);
    }
};
