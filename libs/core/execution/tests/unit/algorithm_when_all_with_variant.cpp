...
{
    {
        ...
        auto s = ex::when_all_with_variant(ex::just(42), ex::just(3.14));
    ...
    {
        std::atomic<bool> set_value_called{false};
        auto s = ex::when_all_with_variant(
            ex::just(42), ex::just(custom_type_non_default_constructible{100}));
    ...
    {
        std::atomic<bool> set_value_called{false};
        auto s = ex::when_all_with_variant(ex::just(), ex::just(42));
