...
template <typename IteratorTag>
void test_min_element_parallel()
{
    using namespace hpx::execution;
...
void min_element_test()
{
    ...
    test_min_element_parallel<std::random_access_iterator_tag>();
}
...
template <typename IteratorTag>
void test_min_element_exception_parallel()
{
    using namespace hpx::execution;
...
void min_element_exception_test()
{
    ...
    test_min_element_exception_parallel<std::random_access_iterator_tag>();
}
...
template <typename IteratorTag>
void test_min_element_bad_alloc_parallel()
{
    using namespace hpx::execution;
...
void min_element_bad_alloc_test()
{
    ...
    test_min_element_bad_alloc_parallel<std::random_access_iterator_tag>();
}
