...
template <typename IteratorTag>
void test_starts_with_sent_proj(IteratorTag)
{
    ...
    auto some_more_ints =
        std::vector<custom_type>(some_ints.begin(), some_ints.begin() + end2);
...
template <typename IteratorTag, typename ExPolicy>
void test_starts_with_sent_proj(ExPolicy policy, IteratorTag)
{
    static_assert(hpx::is_execution_policy<ExPolicy>::value,
        "hpx::is_execution_policy<ExPolicy>::value");
...
template <typename IteratorTag>
void test_starts_with_proj(IteratorTag)
{
    auto end1 = std::rand() % 10007 + 1;
    auto end2 = std::rand() % end1;
    auto some_ints = std::vector<custom_type>(end1);
...
template <typename ExPolicy, typename IteratorTag>
void test_starts_with_proj(ExPolicy policy, IteratorTag)
{
    static_assert(hpx::is_execution_policy<ExPolicy>::value,
        "hpx::is_execution_policy<ExPolicy>::value");
...
template <typename ExPolicy, typename IteratorTag>
void test_starts_with_async_proj(ExPolicy p, IteratorTag)
{
    auto end1 = std::rand() % 10007 + 1;
    auto end2 = std::rand() % end1;
    auto some_ints = std::vector<custom_type>(end1);
