...
int hpx_main(hpx::program_options::variables_map& vm)
{
    ...
    uninitialized_fill_sender_test<std::forward_iterator_tag>();
    uninitialized_fill_sender_test<std::random_access_iterator_tag>();

    uninitialized_fill_exception_sender_test<std::forward_iterator_tag>();
    uninitialized_fill_exception_sender_test<std::random_access_iterator_tag>();

    uninitialized_fill_bad_alloc_sender_test<std::forward_iterator_tag>();
    uninitialized_fill_bad_alloc_sender_test<std::random_access_iterator_tag>();
