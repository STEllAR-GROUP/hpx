//----------------------------------------------------------------------------
/// \file test_partial_sort_parallel.cpp
/// \brief Test program of the partial_sort function
///
...
//--------------------------------------------------------------------------
// Test and compare the hpx::partial_sort copy with std::partial_sort_copy
// in a small group of elements with the three cases
//---------------------------------------------------------------------------
void function01(void)
{
	...
	hpxp::partial_sort_copy (::hpx::execution::par,
			                 l.begin(), l.end(), &v1[0], & v1[4]);
...
int test_main (void)
{
	hpx::cout<<"----------- test_partial_sort_copy_parallel ----------------\n";
	function01();
    function02();
    function03();
    hpx::cout<<"------------------------ end -------------------------------\n";
