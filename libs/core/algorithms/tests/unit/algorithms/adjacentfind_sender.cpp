...
void adjacent_find_sender_test()
{
    ...
    test_adjacent_find_sender(hpx::launch::sync, seq(task), IteratorTag());
...
int hpx_main(hpx::program_options::variables_map& vm)
{
    ...
    adjacent_find_sender_test<std::forward_iterator_tag>();
    adjacent_find_sender_test<std::random_access_iterator_tag>();
