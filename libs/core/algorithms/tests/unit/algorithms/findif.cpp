...
////////////////////////////////////////////////////////////////////////////
template <typename IteratorTag>
void test_find_if_cross_policy()
{
    test_find_if_cross_policy(IteratorTag());
}

void find_if_cross_policy_test()
{
    test_find_if_cross_policy<std::random_access_iterator_tag>();
    test_find_if_cross_policy<std::forward_iterator_tag>();
}
