...
void test_for_loop_strided_sender(LnPolicy ln_policy, ExPolicy&& ex_policy, IteratorTag)
{
...
void for_loop_strided_sender_test()
{
    ...
    test_for_loop_strided_sender(hpx::launch::async, par_unseq(task), IteratorTag());
}
