...
namespace hpx::parallel::traits {
    ...
    namespace detail {
        ...
        HPX_CXX_EXPORT template <typename Proj, typename Iter>
        ...
        HPX_CXX_EXPORT template <typename Projected>
        ...
        HPX_CXX_EXPORT template <typename Proj, typename ValueType,
            typename Enable = void>
        ...
        HPX_CXX_EXPORT template <typename Projected, typename Enable = void>
    ...
    HPX_CXX_EXPORT template <typename F, typename Iter, typename Enable = void>
    struct projected_result_of
