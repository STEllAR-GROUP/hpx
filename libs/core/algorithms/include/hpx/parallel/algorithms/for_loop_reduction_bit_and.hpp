...
/// \file parallel/algorithms/for_loop_reduction_bit_and.hpp
/// \page hpx::experimental::reduction_bit_and
...
namespace hpx::experimental {
    ...
    /// The function template \a reduction_bit_and returns a reduction object of
    /// unspecified type having a value type and encapsulating an identity value
    /// for the reduction, it uses std::bit_and{} as its combiner function, and
    /// a live-out object from which the initial value is obtained and into
    /// which the final value is stored.
    ///
    /// A parallel algorithm uses the \a reduction_bit_and object by allocating
    ...
    /// std::bit_and{} operation until a single value remains, which is then
