...
friend typename hpx::parallel::util::detail::algorithm_result<ExPolicy,
    FwdIter3>::type
tag_fallback_invoke(set_intersection_t, ExPolicy&& policy, FwdIter1 first1,
    ...
    Pred&& op = Pred())
{
    ...
    return hpx::parallel::util::get_third_element(
        hpx::parallel::v1::detail::set_intersection<result_type>().call2(
            HPX_FORWARD(ExPolicy, policy), is_seq(), first1, last1, first2,
            last2, dest, HPX_FORWARD(Pred, op),
