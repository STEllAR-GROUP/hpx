...
{
    return parallel::util::get_second_element(parallel::v1::detail::transfer<
...
friend typename hpx::parallel::util::detail::algorithm_result<ExPolicy,
    FwdIter2>::type
tag_fallback_invoke(
    hpx::copy_n_t, ExPolicy&& policy, FwdIter1 first, Size count, FwdIter2 dest)
{
    ...
    hpx::copy_n_t, FwdIter1 first, Size count, FwdIter2 dest)
{
    ...
    if (hpx::parallel::v1::detail::is_negative(count))
    {
        return hpx::parallel::util::detail::algorithm_result<
            hpx::execution::sequenced_policy, FwdIter2>::get(HPX_MOVE(dest));
    }
...
// clang-format on
friend FwdIter2 tag_fallback_invoke(
    hpx::copy_if_t, FwdIter1 first, FwdIter1 last, FwdIter2 dest, Pred&& pred)
{
    static_assert((hpx::traits::is_forward_iterator_v<FwdIter1>),
        "Required at least forward iterator.");
    static_assert((hpx::traits::is_output_iterator_v<FwdIter2>),
