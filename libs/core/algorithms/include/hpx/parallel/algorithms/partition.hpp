                ...
                std::size_t chunks)
            {
                ...
                return hpx::dataflow(
                    ...
                    [mid](hpx::future<RandIter>&& leftf,
                        ...
                        std::advance(first_it, detail::distance(mid, last_it));
                        return first_it;
                    },
        ...
        HPX_CXX_CORE_EXPORT struct partition_helper
        {
            ...
            public:
                block_manager(
                  ...
                  : first_(first)
                  , left_(0)
                  , right_(detail::distance(first, last))
            ...
            public:
                ...
                block_manager(
                  ...
                  : boundary_(first)
                  , blocks_((detail::distance(first, last) + block_size - 1) /
                        block_size)
                {
                    left_ = 0;
                    right_ = blocks_.size();
