...
namespace hpx { namespace ranges {
    ...
    ///           \a hpx::future<ranges::set_union_result<RaIter1, RaIter2, RaIter3>>
    ///           if the execution policy is of type
    ///           \a sequenced_task_policy or
    ///           \a parallel_task_policy and
    ///           returns \a ranges::set_union_result<RaIter1, RaIter2, RaIter3> otherwise.
    ...
    typename typename hpx::parallel::util::detail::algorithm_result<ExPolicy,
        set_union_result<RaIter1, RaIter2, RaIter3>>::type
    set_union(ExPolicy&& policy, RaIter1 first1, Sent1 last1, RaIter2 first2,
        Sent2 last2, RaIter3 dest, Pred&& op = Pred(), Proj1&& proj1 = Proj1(),
        Proj2&& proj2 = Proj2());
    ...
    typename hpx::parallel::util::detail::algorithm_result<ExPolicy,
        set_union_result<hpx::traits::range_iterator_t<Rng1>,
            hpx::traits::range_iterator_t<Rng2>, RaIter3>>
    set_union(ExPolicy&& policy, Rng1&& rng1, Rng2&& rng2, RaIter3 dest,
    ...
    set_union_result<
        ...
        hpx::traits::range_iterator_t<Rng2>, RaIter3>
    set_union(Rng1&& rng1, Rng2&& rng2, RaIter3 dest, Pred&& op = Pred(),
...
namespace hpx::ranges {
    ...
    private:
        ...
        friend hpx::parallel::util::detail::algorithm_result_t<ExPolicy,
            set_union_result<RaIter1, RaIter2, RaIter3>>
        tag_fallback_invoke(set_union_t, ExPolicy&& policy, RaIter1 first1,
            ...
            Pred op = Pred(), Proj1 proj1 = Proj1(), Proj2 proj2 = Proj2())
        {
            ...
            using result_type = set_union_result<RaIter1, RaIter2, RaIter3>;
        ...
        tag_fallback_invoke(set_union_t, ExPolicy&& policy, Rng1&& rng1,
            Rng2&& rng2, RaIter3 dest, Pred op = Pred(), Proj1 proj1 = Proj1(),
            Proj2 proj2 = Proj2())
        {
            ...
            using result_type =
                set_union_result<iterator_type1, iterator_type2, RaIter3>;
        ...
        // clang-format on
        friend set_union_result<hpx::traits::range_iterator_t<Rng1>,
