...
/// \page hpx::ranges::set_difference
...
namespace hpx { namespace ranges {
    ...
    ///                     representing the first sequence. This iterator type must
    ...
    ///                     representing the second sequence. This iterator type must
    ///                     meet the requirements of an random access iterator.
    ...
    ///           \a hpx::future<ranges::set_difference_result<RaIter1, RaIter3>>
    ///           if the execution policy is of type
    ///           \a sequenced_task_policy or
    ///           \a parallel_task_policy and
    ///           returns \a ranges::set_difference_result<RaIter1, RaIter3> otherwise.
    ...
    template <typename ExPolicy, typename RaIter1, typename Sent1, typename RaIter2,
        typename Sent2, typename RaIter3,
        typename Pred = hpx::parallel::detail::less,
        typename Proj1 = hpx::identity,
        typename Proj2 = hpx::identity>
    typename hpx::parallel::util::detail::algorithm_result<ExPolicy,
        set_difference_result<RaIter1, RaIter3>>::type
    set_difference(ExPolicy&& policy, RaIter1 first1, Sent1 last1,
    ...
    typename hpx::parallel::util::detail::algorithm_result<ExPolicy,
        set_difference_result<
            hpx::traits::range_iterator_t<Rng1>, RaIter3>>
    set_difference(ExPolicy&& policy, Rng1&& rng1, Rng2&& rng2, RaIter3 dest,
    ...
    ///                     representing the first sequence. This iterator
    ...
    template <typename Rng1, typename Rng2, typename RaIter3,
        ...
        typename Proj1 = hpx::identity,
        typename Proj2 = hpx::identity>
    set_difference_result<hpx::traits::range_iterator_t<Rng1>, RaIter3>
    set_difference(Rng1&& rng1, Rng2&& rng2, RaIter3 dest, Pred&& op = Pred(),
        Proj1&& proj1 = Proj1(), Proj2&& proj2 = Proj2());
...
namespace hpx::ranges {
    ...
    private:
        ...
        friend hpx::parallel::util::detail::algorithm_result_t<ExPolicy,
            set_difference_result<RaIter1, RaIter3>>
        tag_fallback_invoke(set_difference_t, ExPolicy&& policy, RaIter1 first1,
            ...
            Pred op = Pred(), Proj1 proj1 = Proj1(), Proj2 proj2 = Proj2())
        {
            ...
            using result_type = set_difference_result<RaIter1, RaIter3>;
            ...
            Proj2 proj2 = Proj2())
        {
            ...
            using result_type = set_difference_result<iterator_type1, RaIter3>;
