...
/// \page hpx::ranges::set_symmetric_difference
...
namespace hpx { namespace ranges {
    ...
    ///                     representing the first sequence. This iterator types
    ...
    ///                     representing the second sequence. This iterator
    ///                     type must meet the requirements of an
    ///                     input iterator.
    /// \tparam Sent2       The type of the end source iterators used (deduced)
    ///                     representing the second sequence. This iterator
    ///                     type must meet the requirements of an
    ...
    /// The resulting range cannot overlap with either of the input ranges.
    ///
    /// \tparam Rng1The type of the source range used (deduced).
    ///                     The iterators extracted from this range type must
