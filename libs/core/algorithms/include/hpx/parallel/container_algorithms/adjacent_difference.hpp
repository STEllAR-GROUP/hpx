...
namespace hpx { namespace ranges {
    ...
    // clang-format off
        ...
        friend typename parallel::util::detail::algorithm_result<ExPolicy,
            FwdIter2>::type
        tag_fallback_dispatch(hpx::ranges::adjacent_difference_t, ExPolicy&& policy, Rng&& rng, FwdIter2 dest)
        {
            static_assert((hpx::traits::is_forward_iterator<hpx::traits::range_iterator_t<Rng>>::value),
                "Required at least forward iterator.");
            typedef typename std::iterator_traits<hpx::traits::range_iterator_t<Rng>>::value_type value_type;
        ...
        friend typename parallel::util::detail::algorithm_result<ExPolicy,
            FwdIter2>::type
        tag_fallback_dispatch(hpx::ranges::adjacent_difference_t, ExPolicy&& policy, Rng&& rng, FwdIter2 dest, Op op)
        {
            static_assert((hpx::traits::is_forward_iterator<hpx::traits::range_iterator_t<Rng>>::value),
                "Required at least forward iterator.");
            typedef typename std::iterator_traits<hpx::traits::range_iterator_t<Rng>>::value_type value_type;
