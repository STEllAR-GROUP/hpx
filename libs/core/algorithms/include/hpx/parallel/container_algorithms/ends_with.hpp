...
namespace hpx { namespace ranges {
    ...
    typename parallel::util::detail::algorithm_result<ExPolicy,
        bool>::type
    ends_with(ExPolicy&& policy, RaIter1 first1, Sent1 last1, RaIter2 first2,
    ...
    private:
            ...
            Proj1 proj1 = Proj1(), Proj2 proj2 = Proj2())
        {
            ...
            return hpx::parallel::detail::ends_with().call(hpx::execution::seq,
                first1, last1, first2, last2, HPX_MOVE(pred), HPX_MOVE(proj1),
                HPX_MOVE(proj2));
        }
            ...
            Proj2 proj2 = Proj2())
        {
            ...
            return hpx::parallel::detail::ends_with().call(hpx::execution::seq,
                ...
                hpx::util::begin(rng2), hpx::util::end(rng2), HPX_MOVE(pred),
