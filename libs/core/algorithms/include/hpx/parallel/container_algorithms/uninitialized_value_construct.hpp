...
namespace hpx { namespace ranges {
    ...
    RaIter uninitialized_value_construct(RaIter first, Sent last);
    ...
    RaIter uninitialized_value_construct_n(RaIter first, Size count);
...
namespace hpx::ranges {
    ...
    private:
        ...
        friend RaIter tag_fallback_invoke(
            hpx::ranges::uninitialized_value_construct_t, RaIter first,
            Sent last)
        {
