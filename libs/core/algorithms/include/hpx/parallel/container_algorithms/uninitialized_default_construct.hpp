...
/// \page hpx::ranges::uninitialized_default_construct, hpx::ranges::uninitialized_default_construct_n
...
namespace hpx { namespace ranges {
    ...
    RaIter uninitialized_default_construct(RaIter first, Sent last);
    ...
    uninitialized_default_construct(ExPolicy&& policy, RaIter first, Sent last);
    ...
    RaIter uninitialized_default_construct_n(RaIter first, Size count);
    ...
    typename typename parallel::util::detail::algorithm_result<ExPolicy,
        RaIter>::type
    uninitialized_default_construct_n(ExPolicy&& policy, RaIter first,
        Size count);
...
namespace hpx::ranges {
    ...
    private:
        ...
        friend RaIter tag_fallback_invoke(
            hpx::ranges::uninitialized_default_construct_t, RaIter first,
            Sent last)
        {
