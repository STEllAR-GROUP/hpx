...
private:
    ...
    friend typename parallel::util::detail::algorithm_result<ExPolicy,
        subrange_t<FwdIter, Sent>>::type
    tag_fallback_invoke(hpx::ranges::rotate_t, ExPolicy&& policy, FwdIter first,
        FwdIter middle, Sent last)
    {
        static_assert(hpx::traits::is_forward_iterator_v<FwdIter>,
            "Requires at least forward iterator.");
...
private:
    ...
    friend rotate_copy_result<FwdIter, OutIter> tag_fallback_invoke(
        hpx::ranges::rotate_copy_t, FwdIter first, FwdIter middle, Sent last,
        OutIter dest_first)
    {
        static_assert((hpx::traits::is_forward_iterator_v<FwdIter>),
            "Requires at least forward iterator.");
        ...
        FwdIter1 first, FwdIter1 middle, Sent last, FwdIter2 dest_first)
    {
        ...
        return hpx::parallel::v1::detail::rotate_copy<
            ...
            .call2(HPX_FORWARD(ExPolicy, policy), is_seq(), first, middle, last,
                dest_first);
    }
