...
namespace hpx::parallel::util {
    ...
    HPX_CXX_CORE_EXPORT inline constexpr std::uint32_t tmsb[256] = {0, 1, 2, 2,
    ...
    HPX_CXX_CORE_EXPORT constexpr std::uint32_t nbits32(
    ...
    // \exception none
    // \return Number of bits
    HPX_CXX_CORE_EXPORT constexpr std::uint32_t nbits64(
