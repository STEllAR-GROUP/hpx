...
namespace hpx::program_options::detail {
    ...
    HPX_CXX_CORE_EXPORT [[nodiscard]] HPX_CORE_EXPORT std::string to_internal(
        std::string const&);
    /** @overload */
    HPX_CXX_CORE_EXPORT [[nodiscard]] HPX_CORE_EXPORT std::string to_internal(
        std::wstring const&);
