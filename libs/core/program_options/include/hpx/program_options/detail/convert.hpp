...
namespace hpx::program_options {
    ...
    /** Convert the input string into internal encoding used by
        ...
        */
    HPX_CORE_EXPORT std::string to_internal(std::string const&);
    /** @overload */
    HPX_CORE_EXPORT std::string to_internal(std::wstring const&);
