...
namespace hpx::util {
    ...
    HPX_CXX_EXPORT struct register_lock_data
    {
    };
    ...
    namespace detail {
        ...
        HPX_CXX_EXPORT struct HPX_CORE_EXPORT lock_data
        {
    ...
    HPX_CXX_EXPORT struct held_locks_data
    {
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_CXX_EXPORT HPX_CORE_EXPORT bool register_lock(
        void const* lock, register_lock_data* data = nullptr) noexcept;
    HPX_CXX_EXPORT HPX_CORE_EXPORT bool unregister_lock(
        void const* lock) noexcept;
    HPX_CXX_EXPORT HPX_CORE_EXPORT void verify_no_locks();
    HPX_CXX_EXPORT HPX_CORE_EXPORT void force_error_on_lock();
    HPX_CXX_EXPORT HPX_CORE_EXPORT void enable_lock_detection() noexcept;
    HPX_CXX_EXPORT HPX_CORE_EXPORT void disable_lock_detection() noexcept;
    HPX_CXX_EXPORT HPX_CORE_EXPORT void trace_depth_lock_detection(
        std::size_t value) noexcept;
    HPX_CXX_EXPORT HPX_CORE_EXPORT bool ignore_lock(void const* lock) noexcept;
    HPX_CXX_EXPORT HPX_CORE_EXPORT bool reset_ignored(
        void const* lock) noexcept;
    HPX_CXX_EXPORT HPX_CORE_EXPORT bool ignore_all_locks() noexcept;
    HPX_CXX_EXPORT HPX_CORE_EXPORT bool reset_ignored_all() noexcept;

    HPX_CXX_EXPORT using registered_locks_error_handler_type =
        hpx::function<void()>;
    ...
    /// a backtrace.
    HPX_CXX_EXPORT HPX_CORE_EXPORT void set_registered_locks_error_handler(
        registered_locks_error_handler_type) noexcept;

    HPX_CXX_EXPORT using register_locks_predicate_type = hpx::function<bool()>;
    ...
    HPX_CXX_EXPORT HPX_CORE_EXPORT void set_register_locks_predicate(
        register_locks_predicate_type) noexcept;

    ///////////////////////////////////////////////////////////////////////////
    HPX_CXX_EXPORT struct ignore_all_while_checking
    {
    ...
    HPX_CXX_EXPORT HPX_CORE_EXPORT std::unique_ptr<held_locks_data>
    get_held_locks_data();

    // set the current thread_local data about held locks
    HPX_CXX_EXPORT HPX_CORE_EXPORT void set_held_locks_data(
        std::unique_ptr<held_locks_data>&& data);

#else

    HPX_CXX_EXPORT template <typename Lock, typename Enable = void>
    ...
    HPX_CXX_EXPORT constexpr inline bool register_lock(
        void const*, util::register_lock_data* = nullptr) noexcept
    {
        return true;
    }
    HPX_CXX_EXPORT constexpr inline bool unregister_lock(void const*) noexcept
    {
        return true;
    }
    HPX_CXX_EXPORT constexpr inline void verify_no_locks() noexcept {}
    HPX_CXX_EXPORT constexpr inline void force_error_on_lock() noexcept {}
    HPX_CXX_EXPORT constexpr inline void enable_lock_detection() noexcept {}
    HPX_CXX_EXPORT constexpr inline void disable_lock_detection() noexcept {}
    HPX_CXX_EXPORT constexpr inline void trace_depth_lock_detection(
        std::size_t /*value*/) noexcept
    {
    }
    HPX_CXX_EXPORT constexpr inline bool ignore_lock(
        void const* /*lock*/) noexcept
    {
        return true;
    }
    HPX_CXX_EXPORT constexpr inline bool reset_ignored(
        void const* /*lock*/) noexcept
    {
        return true;
    }

    HPX_CXX_EXPORT constexpr inline bool ignore_all_locks() noexcept
    {
        return true;
    }
    HPX_CXX_EXPORT constexpr inline bool reset_ignored_all() noexcept
    {
        return true;
    }
    ...
    HPX_CXX_EXPORT constexpr inline held_locks_data*
    get_held_locks_data() noexcept
    {
        return nullptr;
    }

    HPX_CXX_EXPORT constexpr inline void set_held_locks_data(
