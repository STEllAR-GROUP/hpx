...
namespace hpx::util {
    ...
    HPX_CXX_CORE_EXPORT using extra_data_id_type = void const*;
    ...
    HPX_CXX_CORE_EXPORT struct extra_data_node;
    HPX_CXX_CORE_EXPORT struct extra_data_member_base;
    HPX_CXX_CORE_EXPORT template <typename T>
    ...
    HPX_CXX_CORE_EXPORT struct extra_data
    {
