...
#  define HPX_LOCAL_EXPORT_REINITIALIZABLE_STATIC HPX_LOCAL_EXPORT
#else
#  define HPX_LOCAL_EXPORT_REINITIALIZABLE_STATIC
#endif
// clang-format on
...
namespace hpx { namespace util {
    ...
    struct HPX_LOCAL_EXPORT_REINITIALIZABLE_STATIC reinitializable_static;
...
#undef HPX_LOCAL_EXPORT_REINITIALIZABLE_STATIC
