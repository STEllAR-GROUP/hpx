...
namespace hpx::functional {
    ...
    HPX_CXX_EXPORT template <auto& Tag>
    ...
    namespace tag_invoke_ns {
        ...
        HPX_CXX_EXPORT inline constexpr tag_invoke_t_ns::tag_invoke_t
            tag_invoke = {};
#else
    ...
    namespace tag_base_ns {
        ...
        HPX_CXX_EXPORT struct enable_tag_invoke_t;
