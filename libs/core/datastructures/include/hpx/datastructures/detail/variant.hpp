...
#define HPX_VARIANT_ALWAYS_INLINE __attribute__((__always_inline__)) inline
#elif defined(_MSC_VER)
#define HPX_VARIANT_ALWAYS_INLINE __forceinline
#else
#define HPX_VARIANT_ALWAYS_INLINE inline
#endif

#if __has_builtin(__builtin_addressof) || \
    (defined(__GNUC__) && __GNUC__ >= 7) || defined(_MSC_VER)
#define HPX_VARIANT_BUILTIN_ADDRESSOF
#endif

#if __has_builtin(__builtin_unreachable) || defined(__GNUC__)
#define HPX_VARIANT_BUILTIN_UNREACHABLE __builtin_unreachable()
#elif defined(_MSC_VER)
#define HPX_VARIANT_BUILTIN_UNREACHABLE __assume(false)
#else
#define HPX_VARIANT_BUILTIN_UNREACHABLE
#endif

#if __has_builtin(__type_pack_element)
#define HPX_VARIANT_TYPE_PACK_ELEMENT
#endif

#if defined(__cpp_constexpr) && __cpp_constexpr >= 200704 && \
    !(defined(__GNUC__) && __GNUC__ == 4 && __GNUC_MINOR__ == 9)
#define HPX_VARIANT_CPP11_CONSTEXPR
#endif

#if defined(__cpp_constexpr) && __cpp_constexpr >= 201304
#define HPX_VARIANT_CPP14_CONSTEXPR
#endif

#if __has_feature(cxx_exceptions) || defined(__cpp_exceptions) || \
    (defined(_MSC_VER) && defined(_CPPUNWIND))
#define HPX_VARIANT_EXCEPTIONS
#endif

#if defined(__cpp_generic_lambdas) || defined(_MSC_VER)
#define HPX_VARIANT_GENERIC_LAMBDAS
#endif

#if defined(__cpp_lib_integer_sequence)
#define HPX_VARIANT_INTEGER_SEQUENCE
#endif

#if defined(__cpp_return_type_deduction) || defined(_MSC_VER)
#define HPX_VARIANT_RETURN_TYPE_DEDUCTION
#endif

#if defined(__cpp_lib_transparent_operators) || defined(_MSC_VER)
#define HPX_VARIANT_TRANSPARENT_OPERATORS
#endif

#if defined(__cpp_variable_templates) || defined(_MSC_VER)
#define HPX_VARIANT_VARIABLE_TEMPLATES
#endif

#if !defined(__GLIBCXX__) || __has_include(<codecvt>)  // >= libstdc++-5
#define HPX_VARIANT_TRIVIALITY_TYPE_TRAITS
#define HPX_VARIANT_INCOMPLETE_TYPE_TRAITS
#endif
...
namespace hpx { namespace variant_ns {

  struct in_place_t { explicit in_place_t() = default; };

#if !defined(HPX_HAVE_CXX17_COPY_ELISION)
  struct in_place_f_t { explicit in_place_f_t() = default; };
#endif
...
#if !defined(HPX_HAVE_CXX17_COPY_ELISION)
  constexpr in_place_f_t in_place_f{};
#endif
...
#else
    std::terminate();
    HPX_VARIANT_BUILTIN_UNREACHABLE;
#endif
  }
...
#if defined(HPX_VARIANT_CPP14_CONSTEXPR) && !defined(_MSC_VER)
#define HPX_VARIANT_VARIANT_SWITCH_VISIT
      ...
      struct base {
...
#ifdef HPX_VARIANT_VARIANT_SWITCH_VISIT
        ...
        struct dispatcher<false, R, ITs...> {
          ...
          HPX_VARIANT_ALWAYS_INLINE static constexpr R dispatch_case(F &&, Vs &&...) {
            HPX_VARIANT_BUILTIN_UNREACHABLE;
          }

          template <std::size_t B, typename F, typename... Vs>
          HPX_VARIANT_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t,
                                                             F &&,
                                                             Vs &&...) {
            HPX_VARIANT_BUILTIN_UNREACHABLE;
          }
...
#define HPX_VARIANT_DEFAULT(I)                                                      \
  dispatcher<(I < lib::decay_t<V>::size()), R, ITs...>::template dispatch<I>( \
      ...
      lib::forward<Vs>(vs)...)
            ...
            switch (v.index()) {
              case B + 0: return HPX_VARIANT_DISPATCH(B + 0);
              case B + 1: return HPX_VARIANT_DISPATCH(B + 1);
              case B + 2: return HPX_VARIANT_DISPATCH(B + 2);
              case B + 3: return HPX_VARIANT_DISPATCH(B + 3);
              case B + 4: return HPX_VARIANT_DISPATCH(B + 4);
              case B + 5: return HPX_VARIANT_DISPATCH(B + 5);
              case B + 6: return HPX_VARIANT_DISPATCH(B + 6);
              case B + 7: return HPX_VARIANT_DISPATCH(B + 7);
              case B + 8: return HPX_VARIANT_DISPATCH(B + 8);
              case B + 9: return HPX_VARIANT_DISPATCH(B + 9);
              case B + 10: return HPX_VARIANT_DISPATCH(B + 10);
              case B + 11: return HPX_VARIANT_DISPATCH(B + 11);
              case B + 12: return HPX_VARIANT_DISPATCH(B + 12);
              case B + 13: return HPX_VARIANT_DISPATCH(B + 13);
              case B + 14: return HPX_VARIANT_DISPATCH(B + 14);
              case B + 15: return HPX_VARIANT_DISPATCH(B + 15);
              case B + 16: return HPX_VARIANT_DISPATCH(B + 16);
              case B + 17: return HPX_VARIANT_DISPATCH(B + 17);
              case B + 18: return HPX_VARIANT_DISPATCH(B + 18);
              case B + 19: return HPX_VARIANT_DISPATCH(B + 19);
              case B + 20: return HPX_VARIANT_DISPATCH(B + 20);
              case B + 21: return HPX_VARIANT_DISPATCH(B + 21);
              case B + 22: return HPX_VARIANT_DISPATCH(B + 22);
              case B + 23: return HPX_VARIANT_DISPATCH(B + 23);
              case B + 24: return HPX_VARIANT_DISPATCH(B + 24);
              case B + 25: return HPX_VARIANT_DISPATCH(B + 25);
              case B + 26: return HPX_VARIANT_DISPATCH(B + 26);
              case B + 27: return HPX_VARIANT_DISPATCH(B + 27);
              case B + 28: return HPX_VARIANT_DISPATCH(B + 28);
              case B + 29: return HPX_VARIANT_DISPATCH(B + 29);
              case B + 30: return HPX_VARIANT_DISPATCH(B + 30);
              case B + 31: return HPX_VARIANT_DISPATCH(B + 31);
              default: return HPX_VARIANT_DEFAULT(B + 32);
            }

#undef HPX_VARIANT_DEFAULT
#undef HPX_VARIANT_DISPATCH
          }

          template <std::size_t I, typename F, typename... Vs>
          HPX_VARIANT_ALWAYS_INLINE static constexpr R dispatch_case(F &&f,
                                                               Vs &&... vs) {
            using Expected = R;
          ...
          template <std::size_t B, typename F, typename V, typename... Vs>
          HPX_VARIANT_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t index,
                                                             F &&f,
                                                             V &&v,
                                                             Vs &&... vs) {
...
#define HPX_VARIANT_DISPATCH_AT(I)                                               \
...
#define HPX_VARIANT_DEFAULT(I)                                                 \
  dispatcher<(I < lib::decay_t<V>::size()), R>::template dispatch_at<I>( \
      index, lib::forward<F>(f), lib::forward<V>(v), lib::forward<Vs>(vs)...)
            ...
            switch (index) {
              case B + 0: return HPX_VARIANT_DISPATCH_AT(B + 0);
              case B + 1: return HPX_VARIANT_DISPATCH_AT(B + 1);
              case B + 2: return HPX_VARIANT_DISPATCH_AT(B + 2);
              case B + 3: return HPX_VARIANT_DISPATCH_AT(B + 3);
              case B + 4: return HPX_VARIANT_DISPATCH_AT(B + 4);
              case B + 5: return HPX_VARIANT_DISPATCH_AT(B + 5);
              case B + 6: return HPX_VARIANT_DISPATCH_AT(B + 6);
              case B + 7: return HPX_VARIANT_DISPATCH_AT(B + 7);
              case B + 8: return HPX_VARIANT_DISPATCH_AT(B + 8);
              case B + 9: return HPX_VARIANT_DISPATCH_AT(B + 9);
              case B + 10: return HPX_VARIANT_DISPATCH_AT(B + 10);
              case B + 11: return HPX_VARIANT_DISPATCH_AT(B + 11);
              case B + 12: return HPX_VARIANT_DISPATCH_AT(B + 12);
              case B + 13: return HPX_VARIANT_DISPATCH_AT(B + 13);
              case B + 14: return HPX_VARIANT_DISPATCH_AT(B + 14);
              case B + 15: return HPX_VARIANT_DISPATCH_AT(B + 15);
              case B + 16: return HPX_VARIANT_DISPATCH_AT(B + 16);
              case B + 17: return HPX_VARIANT_DISPATCH_AT(B + 17);
              case B + 18: return HPX_VARIANT_DISPATCH_AT(B + 18);
              case B + 19: return HPX_VARIANT_DISPATCH_AT(B + 19);
              case B + 20: return HPX_VARIANT_DISPATCH_AT(B + 20);
              case B + 21: return HPX_VARIANT_DISPATCH_AT(B + 21);
              case B + 22: return HPX_VARIANT_DISPATCH_AT(B + 22);
              case B + 23: return HPX_VARIANT_DISPATCH_AT(B + 23);
              case B + 24: return HPX_VARIANT_DISPATCH_AT(B + 24);
              case B + 25: return HPX_VARIANT_DISPATCH_AT(B + 25);
              case B + 26: return HPX_VARIANT_DISPATCH_AT(B + 26);
              case B + 27: return HPX_VARIANT_DISPATCH_AT(B + 27);
              case B + 28: return HPX_VARIANT_DISPATCH_AT(B + 28);
              case B + 29: return HPX_VARIANT_DISPATCH_AT(B + 29);
              case B + 30: return HPX_VARIANT_DISPATCH_AT(B + 30);
              case B + 31: return HPX_VARIANT_DISPATCH_AT(B + 31);
              default: return HPX_VARIANT_DEFAULT(B + 32);
            }

#undef HPX_VARIANT_DEFAULT
#undef HPX_VARIANT_DISPATCH_AT
          }
        };
#else
        template <typename T>
...
#if !defined(HPX_HAVE_CXX17_COPY_ELISION)
      template <typename F, typename... Args>
      inline explicit constexpr alt(in_place_f_t, F&& f, Args&&... args)
        : value(lib::forward<F>(f)(lib::forward<Args>(args)...)) {}
#endif
#ifdef _MSC_VER
#pragma warning(pop)
#endif
...
#define HPX_VARIANT_VARIANT_RECURSIVE_UNION(destructible_trait, destructor)      \
  ...
  union recursive_union<destructible_trait, Index, T, Ts...> {             \
    ...
    HPX_VARIANT_VARIANT_RECURSIVE_UNION(Trait::TriviallyAvailable,
                                  ~recursive_union() = default;);
    HPX_VARIANT_VARIANT_RECURSIVE_UNION(Trait::Available,
                                  ~recursive_union() {});
    HPX_VARIANT_VARIANT_RECURSIVE_UNION(Trait::Unavailable,
...
#define HPX_VARIANT_VARIANT_DESTRUCTOR(destructible_trait, definition, destroy) \
  ...
  class destructor<traits<Ts...>, destructible_trait>                     \
    ...
    using super = base<destructible_trait, Ts...>;                        \
                                                                          \
    public:                                                               \
    HPX_VARIANT_INHERITING_CTOR(destructor, super)                              \
    ...
    HPX_VARIANT_VARIANT_DESTRUCTOR(
        Trait::TriviallyAvailable,
        ~destructor() = default;,
...
#undef HPX_VARIANT_VARIANT_DESTRUCTOR
    ...
    class constructor : public destructor<Traits> {
      ...
      public:
      HPX_VARIANT_INHERITING_CTOR(constructor, super)
      using super::operator=;

      protected:
#ifndef HPX_VARIANT_GENERIC_LAMBDAS
      struct ctor {
...
#if !defined(HPX_HAVE_CXX17_COPY_ELISION)
      template <std::size_t I, typename T, typename... Args>
      inline static T &construct_alt_f(alt<I, T> &a, Args &&... args) {
        auto *result = ::new (static_cast<void *>(lib::addressof(a)))
            alt<I, T>(in_place_f_t{}, lib::forward<Args>(args)...);
        return result->value;
      }
#endif
      ...
      inline static void generic_construct(constructor &lhs, Rhs &&rhs) {
        ...
        if (!rhs.valueless_by_exception()) {
          visitation::alt::visit_alt_at(
              rhs.index(),
#ifdef HPX_VARIANT_GENERIC_LAMBDAS
...
#define HPX_VARIANT_VARIANT_MOVE_CONSTRUCTOR(move_constructible_trait, definition) \
  ...
  class move_constructor<traits<Ts...>, move_constructible_trait>            \
    ...
    using super = constructor<traits<Ts...>>;                                \
                                                                             \
    public:                                                                  \
    HPX_VARIANT_INHERITING_CTOR(move_constructor, super)                           \
    using super::operator=;                                                  \
                                                                             \
    ...
    HPX_VARIANT_VARIANT_MOVE_CONSTRUCTOR(
        Trait::TriviallyAvailable,
...
#define HPX_VARIANT_VARIANT_COPY_CONSTRUCTOR(copy_constructible_trait, definition) \
  ...
  class copy_constructor<traits<Ts...>, copy_constructible_trait>            \
    ...
    using super = move_constructor<traits<Ts...>>;                           \
                                                                             \
    public:                                                                  \
    HPX_VARIANT_INHERITING_CTOR(copy_constructor, super)                           \
    using super::operator=;                                                  \
                                                                             \
    definition                                                               \
    ...
    HPX_VARIANT_VARIANT_COPY_CONSTRUCTOR(
        Trait::TriviallyAvailable,
...
#undef HPX_VARIANT_VARIANT_COPY_CONSTRUCTOR
    ...
    class assignment : public copy_constructor<Traits> {
      ...
      public:
      HPX_VARIANT_INHERITING_CTOR(assignment, super)
      using super::operator=;
...
#if !defined(HPX_HAVE_CXX17_COPY_ELISION)
      template <std::size_t I, typename... Args>
      inline /* auto & */ auto emplace_f(Args &&... args)
          -> decltype(this->construct_alt_f(access::base::get_alt<I>(*this),
                                          lib::forward<Args>(args)...)) {
        this->destroy();
        auto &result = this->construct_alt_f(access::base::get_alt<I>(*this),
                                           lib::forward<Args>(args)...);
        this->index_ = I;
        return result;
      }
...
#define HPX_VARIANT_VARIANT_MOVE_ASSIGNMENT(move_assignable_trait, definition) \
  ...
  class move_assignment<traits<Ts...>, move_assignable_trait>            \
    ...
    using super = assignment<traits<Ts...>>;                             \
                                                                         \
    public:                                                              \
    HPX_VARIANT_INHERITING_CTOR(move_assignment, super)                        \
    using super::operator=;                                              \
                                                                         \
    ...
    HPX_VARIANT_VARIANT_MOVE_ASSIGNMENT(
        Trait::TriviallyAvailable,
...
#define HPX_VARIANT_VARIANT_COPY_ASSIGNMENT(copy_assignable_trait, definition) \
  ...
  class copy_assignment<traits<Ts...>, copy_assignable_trait>            \
    ...
    using super = move_assignment<traits<Ts...>>;                        \
                                                                         \
    public:                                                              \
    HPX_VARIANT_INHERITING_CTOR(copy_assignment, super)                        \
    using super::operator=;                                              \
                                                                         \
    ...
    HPX_VARIANT_VARIANT_COPY_ASSIGNMENT(
        Trait::TriviallyAvailable,
...
#undef HPX_VARIANT_VARIANT_COPY_ASSIGNMENT
    ...
    class impl : public copy_assignment<traits<Ts...>> {
      ...
      public:
      HPX_VARIANT_INHERITING_CTOR(impl, super)
      using super::operator=;
  ...
  struct hash<hpx::variant_ns::detail::enabled_type<
      ...
      hpx::variant_ns::lib::enable_if_t<
          hpx::variant_ns::lib::all<
              hpx::variant_ns::detail::hash::is_enabled<
              hpx::variant_ns::lib::remove_const_t<Ts>>()...>::value>>> {
    using argument_type = hpx::variant_ns::variant<Ts...>;
    using result_type = std::size_t;

    inline result_type operator()(const argument_type &v) const {
      using hpx::variant_ns::detail::visitation::variant;
      std::size_t result =
...
#ifdef HPX_VARIANT_GENERIC_LAMBDAS
                    [](const auto &alt) {
                      using alt_type = hpx::variant_ns::lib::decay_t<decltype(alt)>;
                      using value_type = hpx::variant_ns::lib::remove_const_t<
    ...
    struct hasher {
      ...
      inline std::size_t operator()(const Alt &alt) const {
        using alt_type = hpx::variant_ns::lib::decay_t<Alt>;
        using value_type =
            hpx::variant_ns::lib::remove_const_t<typename alt_type::value_type>;
        return hash<value_type>{}(alt.value);
      }
    };
#endif
