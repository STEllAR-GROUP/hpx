...
namespace hpx { namespace util
{
    ...
    namespace detail
    {
        ...
        struct mem_fn
        {
            ...
            HPX_CONSTEXPR typename util::invoke_result<MemberPointer, Ts...>::type
    ...
    HPX_CONSTEXPR detail::mem_fn<M C::*>
    mem_fn(M C::*pm)
    {
    ...
    HPX_CONSTEXPR detail::mem_fn<R (C::*)(Ps...)>
    mem_fn(R (C::*pm)(Ps...))
    {
    ...
    template <typename R, typename C, typename ...Ps>
    HPX_CONSTEXPR detail::mem_fn<R (C::*)(Ps...) const>
