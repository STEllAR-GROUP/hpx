...
{
    static_assert(
        hpx::basic_execution::traits::is_receiver<mylib::receiver_1>::value,
        "mylib::receiver_1 should be a receiver");
    static_assert(
        hpx::basic_execution::traits::is_receiver_of<mylib::receiver_1,
            int>::value,
    ...
    static_assert(
        !hpx::basic_execution::traits::is_receiver<mylib::receiver_2>::value,
        "mylib::receiver_2 should not be a receiver of std::exception_ptr");
    static_assert(hpx::basic_execution::traits::is_receiver<mylib::receiver_2,
                      int>::value,
        "mylib::receiver_2 should be a receiver");
    static_assert(
        !hpx::basic_execution::traits::is_receiver_of<mylib::receiver_2,
            int>::value,
    ...
    static_assert(
        ...
        "mylib::receiver_1 should be a receiver");
    static_assert(
        hpx::basic_execution::traits::is_receiver_of<mylib::receiver_3,
            int>::value,
    ...
    static_assert(!hpx::basic_execution::traits::is_receiver<
                      mylib::non_receiver_1>::value,
        "mylib::non_receiver_1 should not be a receiver");
    static_assert(
        !hpx::basic_execution::traits::is_receiver_of<mylib::non_receiver_1,
            int>::value,
        "mylib::non_receiver_1 should not be a receiver of int");
    static_assert(!hpx::basic_execution::traits::is_receiver<
                      mylib::non_receiver_2>::value,
        "mylib::non_receiver_2 should not be a receiver");
    static_assert(
        !hpx::basic_execution::traits::is_receiver_of<mylib::non_receiver_2,
            int>::value,
        "mylib::non_receiver_2 should not be a receiver of int");
    static_assert(!hpx::basic_execution::traits::is_receiver<
                      mylib::non_receiver_3>::value,
        "mylib::non_receiver_3 should not be a receiver");
    static_assert(
        !hpx::basic_execution::traits::is_receiver_of<mylib::non_receiver_3,
            int>::value,
    ...
    static_assert(
        !hpx::basic_execution::traits::is_receiver_of<mylib::non_receiver_4,
            int>::value,
        "mylib::non_receiver_4 should not be a receiver of int");
    static_assert(!hpx::basic_execution::traits::is_receiver<
                      mylib::non_receiver_5>::value,
        "mylib::non_receiver_5 should not be a receiver");
    static_assert(
        !hpx::basic_execution::traits::is_receiver_of<mylib::non_receiver_5,
            int>::value,
        "mylib::non_receiver_5 should not be a receiver of int");
    static_assert(!hpx::basic_execution::traits::is_receiver<
                      mylib::non_receiver_6>::value,
        "mylib::non_receiver_6 should not be a receiver");
    static_assert(
        !hpx::basic_execution::traits::is_receiver_of<mylib::non_receiver_6,
            int>::value,
        "mylib::non_receiver_6 should not be a receiver of int");
    static_assert(!hpx::basic_execution::traits::is_receiver<
                      mylib::non_receiver_7>::value,
        "mylib::non_receiver_7 should not be a receiver");
    static_assert(
        !hpx::basic_execution::traits::is_receiver_of<mylib::non_receiver_7,
            int>::value,
