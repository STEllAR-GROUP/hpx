...
#ifndef HPX_LEXICAL_CAST_DETAIL_BASIC_POINTERBUF_HPP
#define HPX_LEXICAL_CAST_DETAIL_BASIC_POINTERBUF_HPP
...
namespace hpx { namespace util { namespace detail {
    ...
    protected:
        ...
        inline typename this_type::pos_type seekpos(
            pos_type sp, ::std::ios_base::openmode which);
        inline typename this_type::pos_type seekoff(off_type off,
    ...
    template <class charT, class BufferT>
    BufferT* basic_pointerbuf<charT, BufferT>::setbuf(
...
#pragma warning(pop)
    ...
    template <class charT, class BufferT>
    typename basic_pointerbuf<charT, BufferT>::pos_type
    basic_pointerbuf<charT, BufferT>::seekpos(
        pos_type sp, ::std::ios_base::openmode which)
    {
        if (which & ::std::ios_base::out)
            return pos_type(off_type(-1));
