...
namespace hpx {
    ...
    typename util::detail::algorithm_result<ExPolicy, util::in_out_result<FwdIter1, FwdIter2>>::type
    transform(ExPolicy&& policy, FwdIter1 first, FwdIter1 last, FwdIter2 dest, F&& f);
    ...
    ///
    /// \returns  The \a transform algorithm returns a
    /// \a hpx::future<in_in_out_result<FwdIter1B, FwdIter2, FwdIter3>>
    ///           if the execution policy is of type \a parallel_task_policy
    ///           and returns
    ...
    typename util::detail::algorithm_result<ExPolicy, util::in_in_out_result<FwdIter1, FwdIter2, FwdIter3>>::type
    transform(ExPolicy&& policy, FwdIter1 first1, FwdIter1 last1, FwdIter2 first2, FwdIter3 dest, F&& f);
    ...
    template <typename ExPolicy, typename FwdIter1, typename FwdIter2, typename FwdIter3, typename F>
    typename util::detail::algorithm_result<ExPolicy, util::in_in_out_result<FwdIter1, FwdIter2, FwdIter3>>::type
    transform(ExPolicy&& policy, FwdIter1 first1, FwdIter1 last1, FwdIter2 first2, FwdIter2 last2, FwdIter3 dest, F&& f);
...
namespace hpx { namespace parallel { inline namespace v1 {
    ...
    namespace detail {
        ...
        struct transform_iteration
        {
            ...
            HPX_HOST_DEVICE HPX_FORCEINLINE
                util::in_out_result<typename hpx::util::tuple_element<0,
    ...
    namespace detail {
        ...
        struct transform_binary_iteration
        {
            ...
            template <typename Iter>
            HPX_HOST_DEVICE HPX_FORCEINLINE
                util::in_in_out_result<typename hpx::util::tuple_element<0,
                                     typename Iter::iterator_tuple_type>::type,
                    typename hpx::util::tuple_element<1,
                        typename Iter::iterator_tuple_type>::type,
...
namespace hpx {
    ...
    private:
        ...
        tag_invoke(hpx::transform_t, ExPolicy&& policy, FwdIter1 first,
            FwdIter1 last, FwdIter2 dest, F&& f)
        {
            typedef parallel::execution::is_sequenced_execution_policy<ExPolicy> is_seq;

            return parallel::util::get_second_element(
                parallel::v1::detail::transform_<
    ...
    namespace hpx { namespace traits {
            ...
            parallel::v1::detail::transform_iteration<ExPolicy, F, Proj>>
        {
            static std::size_t call(
                parallel::v1::detail::transform_iteration<ExPolicy, F,
                    Proj> const& f) noexcept
            {
