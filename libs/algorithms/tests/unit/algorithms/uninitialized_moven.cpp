...
void test_uninitialized_move_n_async(ExPolicy p, IteratorTag)
{
    ...
    auto f =
        hpx::parallel::uninitialized_move_n(p,
            iterator(std::begin(c)), c.size(), std::begin(d));
    f.wait();
...
void test_uninitialized_move_n()
{
    ...
    test_uninitialized_move_n_async(execution::seq(execution::task),
        IteratorTag());
    test_uninitialized_move_n_async(execution::par(execution::task),
        IteratorTag());
}
...
void test_uninitialized_move_n_exception()
{
    ...
    test_uninitialized_move_n_exception_async(execution::seq(execution::task),
        IteratorTag());
    test_uninitialized_move_n_exception_async(execution::par(execution::task),
        IteratorTag());
}
...
void test_uninitialized_move_n_bad_alloc()
{
    ...
    test_uninitialized_move_n_bad_alloc_async(execution::seq(execution::task),
        IteratorTag());
    test_uninitialized_move_n_bad_alloc_async(execution::par(execution::task),
        IteratorTag());
}
