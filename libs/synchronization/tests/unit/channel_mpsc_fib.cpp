...
///////////////////////////////////////////////////////////////////////////////
void produce_numbers(hpx::lcos::local::channel_mpsc<int>& c2,
    hpx::lcos::local::channel_mpsc<int>& c3)
{
    int f1 = 1, f2 = 0;
...
void consume_numbers(int n, hpx::lcos::local::channel_mpsc<bool>& c1,
    hpx::lcos::local::channel_mpsc<int>& c2,
    hpx::lcos::local::channel_mpsc<int>& c3)
{
    channel_set(c2, n);
...
{
    hpx::lcos::local::channel_mpsc<bool> c1(1);
    hpx::lcos::local::channel_mpsc<int> c2(1);
    hpx::lcos::local::channel_mpsc<int> c3(5);
