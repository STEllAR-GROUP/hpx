...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime_configuration/static_factory_data.hpp is deprecated, \
    please include hpx/runtime_configuration/static_factory_data.hpp instead")
#else
#warning "The header hpx/runtime_configuration/static_factory_data.hpp is deprecated, \
    please include hpx/runtime_configuration/static_factory_data.hpp instead"
#endif
#endif
