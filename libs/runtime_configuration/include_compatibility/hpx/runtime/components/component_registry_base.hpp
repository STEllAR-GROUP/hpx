...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime_configuration/component_registry_base.hpp is deprecated, \
    please include hpx/runtime_configuration/component_registry_base.hpp instead")
#else
#warning "The header hpx/runtime_configuration/component_registry_base.hpp is deprecated, \
    please include hpx/runtime_configuration/component_registry_base.hpp instead"
#endif
#endif
