...
typedef hpx::components::component<simple_refcnt_checker> refcnt_checker_type;
...
HPX_REGISTER_DISABLED_COMPONENT_FACTORY(
    hpx::components::component<simple_refcnt_checker>, simple_refcnt_checker)

///////////////////////////////////////////////////////////////////////////////
HPX_REGISTER_ACTION(simple_refcnt_checker::take_reference_action,
