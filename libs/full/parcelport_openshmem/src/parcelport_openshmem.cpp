    ...
    namespace policies::openshmem {
        ...
        class HPX_EXPORT parcelport : public parcelport_impl<parcelport>
        {
            ...
            static parcelset::locality here()
            {
                return parcelset::locality(
                    locality(util::openshmem_environment::enabled() ?
                            util::openshmem_environment::rank() :
                            -1));
            }
                ...
                util::runtime_configuration const& ini)
            {
                return hpx::util::get_entry_as<std::size_t>(ini,
                    "hpx.parcel.openshmem.max_connections",
        ...
        public:
            ...
            void do_stop()
            {
                ...
                {
                    stopped_ = true;
                    hpx::util::openshmem_environment::global_barrier();
                }
            }
            ...
            {
                return util::openshmem_environment::get_processor_name();
            }
            ...
            {
                return parcelset::locality(
                    locality(util::openshmem_environment::enabled() ? 0 : -1));
            }
            ...
            void early_write_handler(std::error_code const& ec, parcel const& p)
            {
                if (ec)
                {
                    ...
                    std::exception_ptr exception = hpx::detail::get_exception(
                        hpx::exception(ec), "openshmem::early_write_handler",
                        __FILE__, __LINE__,
...
namespace hpx::traits {
    ...
    //
    //      [hpx.parcel.openshmem]
    //      ...
    //      priority = 1
    //
    template <>
    struct plugin_config_data<hpx::parcelset::policies::openshmem::parcelport>
    {
