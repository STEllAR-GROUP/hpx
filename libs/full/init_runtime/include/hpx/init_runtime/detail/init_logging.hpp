...
namespace hpx {
    ...
    namespace util {
        ...
        void init_agas_log(util::section const& ini, bool isconsole, DefineFormatters&& define_formatters)
        {
        ...
        template <typename ConsoleDestination, typename DefineFormatters>
        void init_parcel_log(util::section const& ini, bool isconsole, DefineFormatters&& define_formatters)
        {
            std::string loglevel, logdest, logformat;
        ...
        template <typename ConsoleDestination, typename DefineFormatters>
        void init_timing_log(util::section const& ini, bool isconsole, DefineFormatters&& define_formatters)
        {
            std::string loglevel, logdest, logformat;
        ...
        template <typename ConsoleDestination, typename DefineFormatters>
        void init_hpx_logs(util::section const& ini, bool isconsole, DefineFormatters&& define_formatters)
        {
            std::string loglevel, logdest, logformat;
        ...
        template <typename ConsoleDestination, typename DefineFormatters>
        void init_app_logs(util::section const& ini, bool isconsole, DefineFormatters&& define_formatters)
        {
            std::string loglevel, logdest, logformat;
        ...
        // initialize logging for application
        template <typename ConsoleDestination, typename DefineFormatters>
        void init_debuglog_logs(util::section const& ini, bool isconsole, DefineFormatters&& define_formatters)
        {
            std::string loglevel, logdest, logformat;
...
namespace hpx { namespace util { namespace detail {
    ///////////////////////////////////////////////////////////////////////////
    template <typename ConsoleDestination, typename DefineFormatters>
    void init_logging(runtime_configuration& ini, bool isconsole, DefineFormatters&& define_formatters)
    {
        ...
        init_debuglog_logs<ConsoleDestination>(ini, isconsole, define_formatters);
