...
namespace hpx::agas {
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_EXPORT bool register_name(launch::sync_policy,
    ...
    HPX_EXPORT hpx::future<hpx::id_type> resolve_name(
        std::string const& name);
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_EXPORT hpx::future<std::vector<std::uint32_t>>
    get_num_threads();
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_EXPORT hpx::future<std::uint32_t>
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_EXPORT std::uint32_t get_locality_id(
        error_code& ec = throws);
    ...
    HPX_EXPORT void remove_resolved_locality(
    ...
    HPX_EXPORT void update_cache_entry(
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_EXPORT hpx::future_or_value<naming::address>
    ...
    HPX_EXPORT bool bind(launch::sync_policy,
        naming::gid_type const& gid, naming::address const& addr,
    ...
    HPX_EXPORT hpx::id_type get_console_locality(
        error_code& ec = throws);
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_EXPORT void decref(naming::gid_type const& id,
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_EXPORT std::int64_t replenish_credits(
        naming::gid_type& gid);
    ...
    ///////////////////////////////////////////////////////////////////////////
    HPX_EXPORT hpx::future<hpx::id_type>
    ...
    HPX_EXPORT hpx::future<void> mark_as_migrated(
        naming::gid_type const& gid,
