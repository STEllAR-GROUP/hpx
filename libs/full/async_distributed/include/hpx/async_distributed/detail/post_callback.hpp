...
namespace hpx {
    ...
    namespace detail {
        ...
        template <typename Action, typename Callback, typename... Ts>
        inline bool post_r_cb(naming::address&& addr, hpx::id_type const& gid,
            Callback&& cb, Ts&&... vs)
        {
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename Action, typename Callback, typename... Ts>
    inline bool post_p_cb(hpx::id_type const& gid,
        threads::thread_priority priority, Callback&& cb, Ts&&... vs)
    {
    ...
    template <typename Action, typename Callback, typename... Ts>
    inline bool post_cb(hpx::id_type const& gid, Callback&& cb, Ts&&... vs)
    {
    ...
    namespace detail {
        ...
        template <typename Action, typename Continuation, typename Callback,
            typename... Ts>
        inline bool post_r_cb(naming::address&& addr, Continuation&& c,
            hpx::id_type const& gid, Callback&& cb, Ts&&... vs)
        {
    ...
    template <typename Action, typename Continuation, typename Callback,
        typename... Ts>
    inline bool post_p_cb(Continuation&& c, naming::address&& addr,
    ...
    template <typename Action, typename Continuation, typename Callback,
        typename... Ts>
    inline bool post_p_cb(Continuation&& c, hpx::id_type const& gid,
        threads::thread_priority priority, Callback&& cb, Ts&&... vs)
    {
    ...
    inline bool post_cb(Continuation&& c,
        hpx::actions::basic_action<Component, Signature, Derived> /*act*/,
        hpx::id_type const& gid, Callback&& cb, Ts&&... vs)
    {
    ...
    inline
        typename std::enable_if<traits::is_continuation<Continuation>::value &&
                traits::is_distribution_policy<DistPolicy>::value,
            bool>::type
        post_cb(Continuation&& c, DistPolicy const& policy, Callback&& cb,
            Ts&&... vs)
    {
    ...
    namespace detail {
        template <typename Action, typename Callback, typename... Ts>
        inline bool post_c_p_cb(naming::address&& addr,
        ...
        template <typename Action, typename Callback, typename... Ts>
        inline bool post_c_cb(naming::address&& addr,
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename Action, typename Callback, typename... Ts>
    inline bool post_c_p_cb(hpx::id_type const& contgid,
        hpx::id_type const& gid, threads::thread_priority priority,
        Callback&& cb, Ts&&... vs)
    {
    ...
    template <typename Action, typename Callback, typename... Ts>
    inline bool post_c_cb(hpx::id_type const& contgid, hpx::id_type const& gid,
        Callback&& cb, Ts&&... vs)
    {
        typedef typename hpx::traits::extract_action<Action>::remote_result_type
            remote_result_type;
    ...
    template <typename Action, typename Callback, typename... Ts>
    inline bool post_c_p_cb(hpx::id_type const& contgid, naming::address&& addr,
        hpx::id_type const& gid, threads::thread_priority priority,
        Callback&& cb, Ts&&... vs)
    {
        typedef typename hpx::traits::extract_action<Action>::remote_result_type
    ...
    template <typename Action, typename Callback, typename... Ts>
    inline bool post_c_cb(hpx::id_type const& contgid, naming::address&& addr,
        hpx::id_type const& gid, Callback&& cb, Ts&&... vs)
    {
        typedef typename hpx::traits::extract_action<Action>::remote_result_type
            remote_result_type;
    ...
    inline bool apply_c_p_cb(Ts&&... ts)
    {
