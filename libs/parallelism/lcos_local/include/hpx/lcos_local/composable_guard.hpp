...
namespace hpx { namespace lcos { namespace local {
    namespace detail {
        ...
        HPX_PARALLELISM_EXPORT void free(guard_task* task);
    ...
    public:
        ...
        friend HPX_PARALLELISM_EXPORT void run_guarded(
    ...
    HPX_PARALLELISM_EXPORT void run_guarded(
