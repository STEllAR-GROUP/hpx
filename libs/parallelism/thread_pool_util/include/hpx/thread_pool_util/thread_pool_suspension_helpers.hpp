...
namespace hpx { namespace threads {
    ...
    ///          has been resumed.
    HPX_PARALLELISM_EXPORT hpx::future<void> resume_processing_unit(
    ...
    ///                  on error instead.
    HPX_PARALLELISM_EXPORT void resume_processing_unit_cb(
        thread_pool_base& pool, util::function_nonser<void(void)> callback,
    ...
    HPX_PARALLELISM_EXPORT hpx::future<void> suspend_processing_unit(
        thread_pool_base& pool, std::size_t virt_core);
    ...
    ///                  is pre-initialized to \a hpx#throws the function will throw
    ///                  on error instead.
    HPX_PARALLELISM_EXPORT void suspend_processing_unit_cb(
    ...
    ///
    /// \throws hpx::exception if called from outside the HPX runtime.
    HPX_PARALLELISM_EXPORT hpx::future<void> resume_pool(
    ...
    ///                 is pre-initialized to \a hpx#throws the function will throw
    ///                 on error instead.
    HPX_PARALLELISM_EXPORT void resume_pool_cb(thread_pool_base& pool,
    ...
    ///
    /// \throws hpx::exception if called from outside the HPX runtime.
    HPX_PARALLELISM_EXPORT hpx::future<void> suspend_pool(
        thread_pool_base& pool);
    ...
    ///         on the pool itself.
    HPX_PARALLELISM_EXPORT void suspend_pool_cb(thread_pool_base& pool,
        util::function_nonser<void(void)> callback, error_code& ec = throws);
