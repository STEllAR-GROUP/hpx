...
double null_function(bool uselibcds) noexcept
{
    ...
    hpx::cds::hpxthread_manager_wrapper cds_hpx_wrap(uselibcds);
...
int hpx_main(variables_map& vm)
{
...

    {
        ...
        std::uint64_t count = vm["futures"].as<std::uint64_t>();
...
int main(int argc, char* argv[])
{
    ...
    params.desc_cmdline = cmdline;
    return init(argc, argv, params);
}
