    ...
    namespace parallel {
        inline namespace v1 {
            ...
            namespace detail {
                ...
                hpx::future<util::in_out_result<FwdIter, FwdIter>> shift_right_helper(
                ...
                struct shift_right : public detail::algorithm<shift_right<IterPair>, IterPair>
                {
                            ...
                            FwdIter last)
                    {
                        return util::detail::algorithm_result<ExPolicy, IterPair>::get(
                            shift_right_helper(std::forward<ExPolicy>(policy), last,
                                new_first, first));
                    }
                };
                /// \endcond
                ...
                rotate(ExPolicy&& policy, FwdIter first, FwdIter new_first, FwdIter last)
            {
                ...
                return detail::rotate<util::in_out_result<FwdIter, FwdIter>>().call2(
                    std::forward<ExPolicy>(policy), is_seq(), last, new_first, first);
            }
