...
int hpx_main(hpx::program_options::variables_map& vm)
{
...

    {
        ...
        // successful replay
        hpx::future<int> f = hpx::experimental::async_replay(sr, &deep_thought);
        ...
        // unsuccessful replay
        f = hpx::experimental::async_replay(usr, &deep_thought);
        try
        {
            f.get();
        }
        ...
        // aborted replay
        f = hpx::experimental::async_replay(a, &no_answer);
        try
        {
            f.get();
        }
        ...
        f = hpx::experimental::async_replay_validate(a, &validate, &no_answer);
        try
        {
            f.get();
        }
