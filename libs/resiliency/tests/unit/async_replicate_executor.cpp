...
{
    {
        ...
        hpx::future<int> f =
            hpx::experimental::async_replicate(exec, 10, &deep_thought);
        HPX_TEST(f.get() == 42);

        // successful replicate_validate
        f = hpx::experimental::async_replicate_validate(
            exec, 10, &validate, &universal_answer);
        HPX_TEST(f.get() == 42);

        // unsuccessful replicate
        f = hpx::experimental::async_replicate(exec, 6, &deep_thought);
        ...
        // aborted replicate
        f = hpx::experimental::async_replicate(exec, 1, &no_answer);
        ...
        f = hpx::experimental::async_replicate_validate(exec, 1, &validate, &no_answer);
