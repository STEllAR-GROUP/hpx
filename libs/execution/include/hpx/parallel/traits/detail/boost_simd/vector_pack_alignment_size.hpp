...
#if !defined(                                                                  \
    HPX_PARALLEL_VECTOR_PACK_ALIGNMENT_SIZE_BOOST_SIMD_SEP_29_2016_0905PM)
...
namespace hpx { namespace parallel { namespace traits {
    ...
    struct is_vector_pack<boost::simd::pack<T, N, Abi>> : std::true_type
    {
    };

    ///////////////////////////////////////////////////////////////////////////
    template <typename T, std::size_t N, typename Abi>
    struct is_scalar_vector_pack<boost::simd::pack<T, N, Abi>> : std::false_type
    {
    };

    template <typename T, typename Abi>
    struct is_scalar_vector_pack<boost::simd::pack<T, 1, Abi>> : std::true_type
    {
    };
