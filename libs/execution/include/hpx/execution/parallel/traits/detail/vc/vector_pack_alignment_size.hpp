...
#ifndef HPX_PARALLEL_TRAITS_VECTOR_PACK_ALIGNMENT_SIZE_VC_SEP_29_2016_0905PM
...
namespace hpx { namespace parallel { namespace traits {
    ///////////////////////////////////////////////////////////////////////////
    template <typename T, typename Abi>
    struct is_vector_pack<Vc::datapar<T, Abi>> : std::true_type
    {
    };
...
*/
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename T, typename Abi>
    struct is_non_scalar_vector_pack<Vc::datapar<T, Abi>> : std::true_type
    {
    };

    template <typename T>
    struct is_non_scalar_vector_pack<
        Vc::datapar<T, Vc::datapar_abi::fixed_size<1>>> : std::false_type
    {
    };
