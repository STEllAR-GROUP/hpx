...
namespace hpx { namespace parallel { namespace execution {
    ...
    namespace detail {
        ...
        HPX_EXPORT void intrusive_ptr_add_ref(shape_iter_impl_base* p);
        HPX_EXPORT void intrusive_ptr_release(shape_iter_impl_base* p);
        ...
        HPX_NORETURN HPX_EXPORT void throw_bad_polymorphic_executor();
        ...
        class HPX_EXPORT polymorphic_executor_base
        {
